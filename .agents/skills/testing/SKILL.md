...
| `.claude\worktrees\*` (worktree 1) | 3002 | 3003 |
| `.claude\worktrees\*` (worktree 2) | 3004 | 3005 |
| `.claude\worktrees\*` (worktree 3) | 3006 | 3007 |
| `.claude\worktrees\*` (worktree 4) | 3008 | 3009 |
...
- **Other worktrees** (under `.claude\worktrees\`): use the next available even port (3002, 3004, 3006, 3008)
...
**Key principle**: Always report which worktree a running dev server belongs to. A server on port 3000 started from the main worktree is **not** the server for a feature worktree under `.claude\worktrees\`.
