...
```
ESO-Hub Skills API (10 pages × 100 skills, filtered to 7 class categories)
...
> **Slug note**: The `--line` flag uses the URL slug from ESO-Hub (e.g., `dawns-wrath`, `winters-embrace`). These may differ slightly from the local filename — the script normalises apostrophe-containing slugs automatically.
