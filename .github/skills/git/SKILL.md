...
### ⚠️ Pre-flight: Check if the current worktree is occupied

Before creating any new branch, check whether the current worktree already has a different feature branch checked out:
