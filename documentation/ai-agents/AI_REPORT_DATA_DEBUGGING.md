...
**IMPORTANT**: Use the **Download and Analyze Reports** skill (`.agents/skills/reports/SKILL.md`) for automated workflows. Manual scripts are provided as alternatives.
...
Use the **Jira Work Items** skill (`.agents/skills/jira/SKILL.md`) for Jira integration.
