...
> **Skill Available**: Use the **ESO Skill Data Regeneration** skill (`.agents/skills/skill-data-regen/SKILL.md`) for automated `lookup_ability`, `validate_skill_module`, and `generate_validation_report` workflows. This document serves as the detailed reference.
