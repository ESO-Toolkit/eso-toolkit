...
This directory contains comprehensive documentation for the ESO Toolkit scribing detection system. Use this index to find the right document for your needs.
...
- `data-downloads/<report-code>/fight-<fight-id>/events/` - Combat log data
...
_Next Review: When new signature scripts are investigated_
