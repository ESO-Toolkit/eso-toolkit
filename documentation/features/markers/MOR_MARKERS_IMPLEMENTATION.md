...
Implemented support for rendering M0RMarkers in the ESO Toolkit's fight replay viewer. M0RMarkers is an ESO addon that allows players to place and share 3D markers in trials and dungeons.
...
Successfully implemented a complete M0RMarkers integration allowing ESO Toolkit users to visualize raid/dungeon markers in the 3D fight replay. The implementation includes:
