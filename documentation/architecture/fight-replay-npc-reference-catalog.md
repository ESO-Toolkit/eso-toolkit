...
| Hel Ra Citadel       | Ra Kotu                         | https://esomodelviewer.com/creatures/post/157-air-atronach-boss         | 9      | **certain**                  | Upgraded: the body names "Parel Nirus **Ra Kotu**". Mesh is `AirAtronach_B_Boss`, **not** Taleria's `AirAtronach_Coral_Boss` — pale carved stone, not coral, so it is not a free alias of her.  |
