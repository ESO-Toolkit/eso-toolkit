...
| -------------------- | ------------------------------- | ----------------------------------------------------------------------- | ------ | ---------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Aetherian Archive    | Lightning Storm Atronach        | https://esomodelviewer.com/creatures/post/154-storm-atronach            | 10     | **certain — SHIPPED**        | Upgraded from _probable_: the post body names "Bitterwind **Lightning Storm Atronach** Stormfist" verbatim. Shipped 2026-09-08 via Route B.                                                       |
...
| Hel Ra Citadel       | Ra Kotu                         | https://esomodelviewer.com/creatures/post/157-air-atronach-boss         | 9      | **certain, but BUILT+REJECTED** | Body names "Parel Nirus **Ra Kotu**". Built 2026-09-08 and rejected on a confetti atlas (38.8% blind). **Needs ONE profile capture** — four cameras would take blind 40.1% -> 18.8%, the largest gain measured here. Not buildable on Taleria's `AirAtronach_Coral_Boss`: that mesh is 3.86 x 3.17 x 2.0 with splayed arms, he is a compact 1:1 subject. |
...
| Sanctum Ophidia      | Ozara                           | https://esomodelviewer.com/creatures/post/117-lamia-red                 | 11     | **certain**                  | Page **swapped** and upgraded: 117 (red) names "… Muiriana the Dark **Ozara** Sellistrix …" in its body; 115 (golden) was the wrong colour variant. Full-body front `view-01` / back `view-03` verified by eye. |
...
| Maw of Lorkhaj       | Rakkhat                         | https://esomodelviewer.com/creatures/post/7-dread-grievous-twilight     | 8      | **blocked — framing**        | A page exists (family; the body names Baron Thirsk / General Zamachar / Lord Warden Dusk, not Rakkhat) but **all 8 plates are pushed-in detail crops** — head, torso, legs, wings — with no full-body front and no orthographic back. See trap 8. |
...
| Halls of Fabrication | Archcustodian                   | https://esomodelviewer.com/creatures/post/129-dwarven-spider            | 11     | **certain** (reference)      | Upgraded: the body names him. Pairing still **uncertain** — a wide low subject with no obvious orthographic front/back pair; eyeball it before building.                                        |
...
| Rockgrove            | Xalvakka                        | https://esomodelviewer.com/creatures/post/84-harvester-dagonic          | 11     | **certain**                  | Upgraded: the body names "… for the following unique one: **Xalvakka**" — the Dagonic variant _is_ him, not a different skin. Blocked on the mesh's straight-tail bind pose, not on reference.  |
...
| Lucent Citadel       | Count Ryelaz and Zilyesset      | Ryelaz: `/creatures/post/7-dread-grievous-twilight`                     | 8 / 10 | **blocked** (both halves)    | Ryelaz is a Grievous Twilight, so he shares Rakkhat's page **and its framing blocker**. Zilyesset is a Fractured Remnant (`/characters/post/181-fractured-remnant`, 10 @1920px, subject 1001-1030px) but that set is a turntable with **no orthographic front/back pair**. |
...
| Ossein Cage          | Overfiend Kazpian               | https://esomodelviewer.com/creatures/post/87-ruinach-boss               | 11     | uncertain                    | Found by a species sweep. Clean full-body pair, but **the page contradicts itself**: its body says Ruinachs are _four-armed_ while every plate shows a **two-armed** horned brute on mesh `Harbinger_B_Boss`, and the body does not name Kazpian. No image of Kazpian exists anywhere to settle it. |
...
| Baron Rize                            | LC    | `/creatures/post/7-dread-grievous-twilight`                                               | 8           | **blocked** — same framing defect as Rakkhat (see trap 8)             |
...
4. **Same species != same boss — but check the body text before believing it.** This entry originally listed Ozara/Lamia, Archcustodian/Dwarven Spider and Xalvakka/Harvester as species-only matches. A sweep of the posts’ **body text** for the extractor’s _species_ names (rather than boss names) then found that all three posts **name their boss verbatim**, and they are now _certain_. The remaining genuine species-only matches are the three Sunspire dragons, the Twins/dro-m’Athra, Jynorah and Skorkhif/Xivkyn, and Xoryn/Dremora. Verify plates by eye before spending a build cycle either way.
