...
front↔back interpolation with no side plate. The *thinness* is faithful rather than a defect
...
6. **The polish/export scripts hardcode Yandir's identity.** `prepare-static-boss.py` sets the
