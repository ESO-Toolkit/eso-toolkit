...
/**
 * Production deployment script for ESO Toolkit
...
const CONFIG = {
  ...
  requiredEnvVars: ['NODE_ENV', 'VITE_BASE_URL', 'VITE_RELEASE_VERSION'],
  optionalEnvVars: ['ERROR_TRACKING_TOKEN', 'ERROR_TRACKING_ENVIRONMENT', 'REACT_APP_VERSION'],
};
