...
import { CLASS_SKILL_LINES, ESO_CLASSES } from '@features/build-editor/data/esoStaticData';
import { CLASS_COLOR_MAP } from '@features/build-editor/theme/classColorMap';
import { copySkillBar, swapSkillBars } from '@features/build-editor/utils/setupTransfer';
import {
  getSkillById,
  getSkillLineIndex,
  getSkillsByCategory,
