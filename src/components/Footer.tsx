...
export const Footer: React.FC = React.memo(() => {
  ...
  const brandBadgeSx = React.useMemo(
    ...
    () => ({
      ...
      padding: { xs: '0.3rem 0.75rem', sm: '0.35rem 0.85rem' },
      ...
      color:
        ...
        theme.palette.mode === 'dark' ? alpha('#e2e8f0', 0.9) : alpha('#0f172a', 0.8),
  ...
  const brandHighlights = React.useMemo(
    ...
    () => ['Real-time analytics', 'Player-built insights', 'Free beta access', 'Community-driven support'],
            ...
            >
              ...
              >
                ...
                <Typography sx={{ color: theme.palette.text.secondary, lineHeight: 1.6 }}>
                  ...
                  Data-driven utilities crafted by raiders for raiders. Surface the insights you need
                  ...
                  to plan faster pulls, tighter logs, and smoother clears.
