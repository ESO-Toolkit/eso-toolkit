      ...
      passives: [
        {
          name: 'Absorb',
          description:
            'Restores 600 Magicka whenever you block an attack. This effect can occur once every 0.25 seconds.',
        ...
        },
        {
          name: 'Essence Drain',
          description:
            'You gain Major Mending for 4 seconds after completing a fully-charged Heavy Attack, increasing your healing done by 16%. You also heal yourself or an ally within 12 meters of the target for 50% of the damage inflicted by the final hit of a fully-charged Heavy Attack.',
          requirement: 'WITH RESTORATION STAFF EQUIPPED',
        },
        {
