...
export const magesGuild: SkillLineData = {
  ...
  skills: [
    // Ultimate abilities
    {
      ...
      description:
        'Call a comet down from the constellations to blast an enemy, dealing 15690 Flame Damage to all enemies in the area, knocking them down, and stunning them for 2 seconds.\n\nAfter impact, enemies in the target area take 4229 Flame Damage every 1 second for 11 seconds.',
    },
    {
      ...
      baseAbilityId: AbilityId.METEOR,
      description:
        'Call a comet down from the constellations to blast an enemy, dealing 17829 Frost Damage to all enemies in the area, knocking them down, stunning them for 2 seconds, and reducing their Movement Speed by 50% for 5 seconds.\n\nAfter impact, enemies in the target area take 4805 Frost Damage every 1 second for 11 seconds.',
    },
    {
      ...
      baseAbilityId: AbilityId.METEOR,
      description:
        'Call a comet down from the constellations to blast an enemy, dealing 15692 Flame Damage to all enemies in the area, knocking them down, and stunning them for 2 seconds.\n\nAfter impact, enemies in the target area take 4229 Flame Damage every 1 second for 11 seconds.\n\nYou generate 10 Ultimate for each enemy hit by the initial blast, up to 6 times.',
    },
    ...
    // Active abilities - Entropy
    {
      ...
      description: 'Bind an enemy with chaotic magic, dealing 17919 Magic Damage over 20 seconds.',
    },
    {
    ...
    },
    {
      ...
      baseAbilityId: AbilityId.ENTROPY,
      description:
        'Bind an enemy with chaotic magic, dealing 17919 Magic Damage over 20 seconds, and healing you for 1536 every 2 seconds.',
    },
    ...
    },
    {
      ...
      baseAbilityId: AbilityId.FIRE_RUNE,
      description:
        'Inscribe a rune of cosmic fire on the earth, which takes 2 seconds to arm and lasts for 20 seconds.\n\nWhen triggered, the rune blasts all enemies in the target area for 8965 Flame Damage and an additional 11099 Flame Damage over 22 seconds.',
    },
    {
      ...
      baseAbilityId: AbilityId.FIRE_RUNE,
      description:
        'Inscribe a rune of cosmic fire on the earth, which takes 2 seconds to arm and lasts for 20 seconds.\n\nWhen triggered, the rune blasts all enemies in the target area for 8965 Flame Damage, knocks them into the air, and stuns them for 3 seconds.',
    },
