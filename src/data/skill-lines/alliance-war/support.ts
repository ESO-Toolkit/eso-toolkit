...
export const support: SkillLineData = {
  ...
  skills: [
    ...
    },
    {
      ...
      description:
        'Launch a blinding flare, revealing stealthed and invisible enemies in the target area for 5 seconds. Exposed enemies cannot return to stealth or invisibility for 4 seconds.\n\nWhile slotted you gain Major Protection, reducing your damage taken by 10%.',
      isUltimate: false,
      isPassive: false,
      maxRank: 4,
    },
    ...
    // Passive abilities
    {
      ...
      name: 'Magicka Aid',
      description: 'Increases your Magicka Recovery by 5% for each Support ability slotted.',
      isUltimate: false,
      isPassive: true,
      maxRank: 1,
    },
