  ...
  skills: [
    {
      ...
      description:
        'Gather the true strength of Apocrypha around you, forming protective tentacles and a damage shield that absorbs 60% of all damage for 10 seconds, up to a max of 36492 damage, scaling off your Max Health.\n\nWhen the shield collapses you lash out, dealing all of the damage absorbed as Magic Damage to enemies within 5 meters over 10 seconds.',
      isUltimate: true,
    ...
    },
    {
      ...
      description:
        'Gather the true strength of Apocrypha, forming a tentacle damage shield that absorbs 60% of all damage for 10 seconds, up to a max of 36493 damage.\n\nWhen the shield absorbs damage, pseudopods cascade out at up to 11 allies within 15 meters, granting them a damage shield for 4 seconds that absorbs up to 6282 damage. These shields can be applied once every 4 seconds. Both shields scale off your Max Health.',
      isUltimate: true,
      baseSkillId: ClassSkillId.ARCANIST_GIBBERING_SHIELD,
    },
    {
      ...
      description:
        'Gather the true strength of Apocrypha as protective tentacles rise from the Abyssal Sea around you. The tentacles form a damage shield that absorbs 60% of all damage for 10 seconds, up to a max of 43351 damage, scaling off your Max Health.\n\nWhen the shield collapses you lash out, dealing all of the damage absorbed as Magic Damage to enemies within 5 meters over 10 seconds.',
      isUltimate: true,
      baseSkillId: ClassSkillId.ARCANIST_GIBBERING_SHIELD,
    },
    {
    ...
    },
    {
      ...
      description:
        'Cast forth a complex rune granting you and your group members Minor Resolve for 20 seconds, increasing your Armor by 2974.\n\nYou gain Minor Protection for 20 seconds, reducing your damage taken by 5%.\n\nThe first time you are damaged while below 50% Health, Minor Protection is consumed to heal you for 2815 Health, scaling off your Max Health, and gain 3300 Armor and Crowd Control Immunity for 7 seconds. This immunity can occur once every 30 seconds.',
      baseSkillId: ClassSkillId.ARCANIST_RUNIC_DEFENSE,
    },
    {
    ...
    },
    {
      ...
      description:
        'Craft a rune that deals 4736 Magic Damage and heals you for 2001 Health, scaling off your Max Health.\n\nYou apply Minor Maim and Minor Lifesteal for 15 seconds, reducing enemy damage done by 5%, and healing you and your allies for 612 Health every 1 second when damaging them.\n\nThe rune taunts for 15 seconds if it would not cause taunt immunity, and generates Crux. While slotted, damage taken is reduced by 2% per active Crux.',
      baseSkillId: ClassSkillId.ARCANIST_RUNIC_JOLT,
    },
    {
      ...
      description:
        'Craft a defensive Apocryphal rune that deals 4736 Physical Damage. The rune steals 2200 Armor and applies Minor Maim for 15 seconds, reducing their damage done by 5%.\n\nThe rune also taunts for 15 seconds if it would not cause taunt immunity, and generates Crux. While slotted, damage taken is reduced by 2% per active Crux.',
      baseSkillId: ClassSkillId.ARCANIST_RUNIC_JOLT,
    },
    {
      ...
      description:
        'Like the rune knights of old, summon a shield that absorbs 5520 damage for 6 seconds, scaling off your Max Health.\n\nThe first time you take direct damage, the shield retaliates and deals 2311 Magic Damage to the attacker, scaling off your Armor.\n\nConsume Crux to heal yourself for 1877 Health, scaling off your Max Health, per Crux spent.',
    ...
    },
    {
      ...
      description:
        'Like the rune knights of old, summon a shield that absorbs 11404 damage for 1 second, and then 2533 damage for 5 seconds if the first shield persists. Both shields scale off your Max Health.\n\nThe first time you take direct damage, the shield retaliates and deals 2311 Magic Damage to the attacker, scaling off your Armor.\n\nConsume Crux to heal yourself for 1877 Health, scaling off your Max Health, per Crux spent.',
      baseSkillId: ClassSkillId.ARCANIST_RUNESPITE_WARD,
    },
    {
      ...
      description:
        'Like the rune knights of old, summon a shield that absorbs 5520 damage for 6 seconds, scaling off your Max Health.\n\nThe first time you take direct damage, the shield retaliates and deals 2311 Magic Damage to the attacker, scaling off your Armor.\n\nConsume Crux to heal yourself 1877 Health, scaling off your Max Health, and refund 30% of Spiteward of the Lucid Mind cost per Crux spent.',
      baseSkillId: ClassSkillId.ARCANIST_RUNESPITE_WARD,
    },
    {
