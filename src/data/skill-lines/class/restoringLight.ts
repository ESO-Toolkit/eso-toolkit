  ...
  skills: [
    {
      ...
      icon: 'ability_templar_rite_of_passage',
      description:
        'Channel the grace of the gods, healing you and nearby allies for 9818 Health every 1 second for 4 seconds.\n\nYou cannot move while channeling, but you gain immunity to all disabling effects.',
      isUltimate: true,
    ...
    },
    {
      ...
      description:
        'Channel the grace of the gods, healing you and nearby allies for 9819 Health every 1 second for 4 seconds.\n\nGain Major Protection, reducing damage you take by 10% for 10 seconds.\n\nYou cannot move while channeling, but you gain immunity to all disabling effects.',
      isUltimate: true,
      baseSkillId: ClassSkillId.TEMPLAR_RITE_OF_PASSAGE,
    },
    {
      ...
      description:
        'Channel the grace of the gods, healing you and nearby allies for 9819 Health every 1 second for 8 seconds.\n\nWhile channeling this ability, you gain immunity to all disabling effects.',
      isUltimate: true,
      baseSkillId: ClassSkillId.TEMPLAR_RITE_OF_PASSAGE,
    },
    {
      ...
      description:
        'Beacon your inner light, healing yourself or a wounded ally in front of you for 12273 Health.',
    ...
    },
    {
      ...
      description:
        'Beacon your inner light, healing yourself or a wounded ally in front of you for 12274 Health.\n\nAlso heals one other injured target for 4225 Health.',
      baseSkillId: ClassSkillId.TEMPLAR_RUSHED_CEREMONY,
    },
    {
    ...
    },
    {
      ...
      description: 'Focus your spiritual devotion, healing you and nearby allies for 9204 Health.',
    ...
    },
    {
      ...
      description:
        "Focus your spiritual devotion, healing you and nearby allies for 9204 Health.\n\nYou heal a single ally outside this ability's radius for an additional 9507 Health.",
      baseSkillId: ClassSkillId.TEMPLAR_HEALING_RITUAL,
    },
    {
    ...
    },
    {
      ...
      description:
        'Create a rune of celestial protection and gain Major Resolve for 20 seconds, increasing your Physical Resistance and Spell Resistance by 5948.\n\nWhile the rune is active you heal for 374 Health every 1 second, scaling off your Max Health. Standing within the rune increases the healing done by 200%.',
    ...
    },
    {
      ...
      description:
        'Exalt in the sacred light of the Aedra, cleansing up to 2 harmful effects from yourself immediately and healing you and nearby allies for 2974 Health every 2 seconds for 20 seconds.\n\nAllies in the area can activate the Purify synergy, cleansing all harmful effects from themselves and healing for 6732 Health.',
    ...
    },
    {
      ...
      description:
        'Exalt in the sacred light of the Aedra, cleansing up to 5 harmful effects from yourself immediately and healing you and nearby allies for 2974 Health every 2 seconds for 30 seconds.\n\nAllies in the area can activate the Purify synergy, cleansing all harmful effects from themselves and healing for 6732 Health.',
      baseSkillId: ClassSkillId.TEMPLAR_CLEANSING_RITUAL,
    },
    {
      ...
      description:
        'Exalt in the sacred light of the Aedra, cleansing up to 2 harmful effects from yourself immediately. While in the area, enemies take 1587 Magic Damage every 2 seconds for 20 seconds which increases by 12% per tick.\n\nAllies in the area can activate the Purify synergy, cleansing all harmful effects from themselves and healing for 6732 Health.',
      baseSkillId: ClassSkillId.TEMPLAR_CLEANSING_RITUAL,
    },
    {
