  ...
  skills: [
    {
      ...
      icon: 'ability_necromancer_006',
      description:
        'Unleash a frostbitten Flesh Colossus to pulverize enemies in the area. The Colossus smashes the ground three times over 3 seconds, dealing 11955 Frost Damage with each smash.\n\nDealing damage applies Major Vulnerability to any enemy hit for 12 seconds, increasing their damage taken by 10%.',
      isUltimate: true,
    ...
    },
    {
      ...
      description:
        'Unleash a frostbitten Flesh Colossus to pulverize enemies in the area. The Colossus smashes the ground three times over 3 seconds, dealing 11956 Frost Damage with each smash. The final smash stuns all enemies hit for 4 seconds.\n\nDealing damage applies Major Vulnerability to any enemy hit for 17 seconds, increasing their damage taken by 10%.',
      isUltimate: true,
      baseSkillId: ClassSkillId.NECROMANCER_FROZEN_COLOSSUS,
    },
    {
      ...
      description:
        'Unleash a pestilent Flesh Colossus to pulverize enemies in the area. The Colossus smashes the ground three times over 3 seconds, dealing 12350, 12966, and 13615 Disease Damage with the first, second, and third smash.\n\nDealing damage applies the Diseased status effect and Major Vulnerability to any enemy hit for 12 seconds, increasing their damage taken by 10%.',
      isUltimate: true,
      baseSkillId: ClassSkillId.NECROMANCER_FROZEN_COLOSSUS,
    },
    {
    ...
    },
    {
      ...
      description:
        'Desecrate the ground at the target location, dealing 11264 Frost Damage over 10 seconds to enemies inside and applying Minor Vulnerability, increasing their damage taken by 5%.\n\nConsumes a corpse on cast to deal 30% more damage.\n\nAn ally in the area can activate the Grave Robber synergy, dealing 8679 Frost Damage to nearby enemies and healing for the damage done.',
    ...
    },
    {
      ...
      description:
        'Desecrate the ground at the target location, dealing 11627 Frost Damage over 10 seconds to enemies inside and applying Minor Vulnerability, increasing their damage taken by 5%.\n\nConsumes a corpse on cast to deal 30% more damage.\n\nYou or an ally in the area can activate the Grave Robber synergy, dealing 8679 Frost Damage to enemies and healing for the damage done.',
      baseSkillId: ClassSkillId.NECROMANCER_BONEYARD,
    },
    {
      ...
      description:
        'Desecrate the ground at the target location, dealing 11627 Frost Damage over 10 seconds to enemies inside and applying Major Breach and Minor Vulnerability, reducing Physical and Spell Resistance by 5948 and increasing damage taken by 5% for 4.1 seconds each tick.\n\nConsumes a corpse on cast to deal 30% more damage.\n\nAn ally in the area can activate the Grave Robber synergy, dealing 8679 Frost Damage to nearby enemies and healing for the damage done.',
      baseSkillId: ClassSkillId.NECROMANCER_BONEYARD,
    },
    {
      ...
      description:
        'Unearth a skeletal mage from the dirt to fight by your side for 20 seconds, while granting you Major Brutality and Sorcery, increasing your Weapon and Spell Damage by 20%. The mage attacks the closest enemy every 2 seconds, dealing 1894 Shock Damage.\n\nCreates a corpse on death if you are in combat.',
    ...
    },
    {
      ...
      description:
        'Unearth a skeletal mage from the dirt to fight by your side for 20 seconds, while granting you Major Brutality and Sorcery, increasing your Weapon and Spell Damage by 20%. The mage attacks the closest enemy every 2 seconds, dealing 1954 Shock Damage to them and all other enemies nearby.\n\nCreates a corpse on death if you are in combat.',
      baseSkillId: ClassSkillId.NECROMANCER_SKELETAL_MAGE,
    },
    {
      ...
      description:
        'Unearth a skeletal archer from the dirt to fight by your side for 20 seconds, while granting you Major Brutality and Sorcery, increasing your Weapon and Spell Damage by 20%. The archer attacks the closest enemy every 2 seconds, dealing 1893 Physical Damage.\n\nEach time the archer deals damage, it deals 15% more damage than the previous attack.\n\nCreates a corpse on death if you are in combat.',
      baseSkillId: ClassSkillId.NECROMANCER_SKELETAL_MAGE,
    },
    {
      ...
      description:
        'Violently drain the last spark of life from a corpse, dealing 22500 Shock Damage over 20 seconds to all enemies around the corpse and between you and the corpse. You also gain Major Savagery and Prophecy for 20 seconds, increasing your Weapon and Spell Critical rating by 2629.\n\nWhile slotted, your damage done is increased by 3%.',
    ...
    },
    {
      ...
      description:
        'Violently drain the last spark of life from a corpse, dealing 22530 Disease Damage over 20 seconds to all enemies around the corpse and between you and the corpse. You also gain Major Savagery and Prophecy for 20 seconds, increasing your Weapon and Spell Critical rating by 2629.\n\nWhen the siphon ends the corpse explodes, dealing an additional 6946 Disease Damage to all enemies nearby.\n\nWhile slotted, your damage done is increased by 3%.',
      baseSkillId: ClassSkillId.NECROMANCER_SHOCKING_SIPHON,
    },
    {
      ...
      description:
        'Violently drain the last spark of life from a corpse, dealing 22530 Shock Damage over 20 seconds to all enemies around the corpse and between you and the corpse. You also gain Major Savagery and Prophecy for 20 seconds, increasing your Weapon and Spell Critical rating by 2629.\n\nWhile siphoning the corpse you gain 150 Health, Magicka, and Stamina Recovery.\n\nWhile slotted, your damage done is increased by 3%.',
      baseSkillId: ClassSkillId.NECROMANCER_SHOCKING_SIPHON,
    },
    {
