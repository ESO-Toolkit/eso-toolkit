...
export const stormCalling: SkillLineData = {
  ...
  skills: [
    ...
    },
    {
      ...
      description:
        'Charge your fists with the power of the storm, replacing your Light and Heavy Attacks with new, stronger abilities.\n\nLight Attacks become lightning bolts, dealing 98 Shock Damage to an enemy up to 28 meters away.\n\nHeavy Attacks blast enemies in a 4 x 6 area for 84 Shock Damage.\n\nThe attacks restore 1200 Magicka and Stamina, and deplete Ultimate until you run out, or the ability is toggled off.',
      isUltimate: true,
      baseSkillId: ClassSkillId.SORCERER_OVERLOAD,
    },
    {
      ...
      description:
        'Charge your fists with the power of the storm, replacing your Light and Heavy Attacks with new, stronger abilities.\n\nLight Attacks become lightning bolts, dealing 108 Shock Damage to an enemy up to 32 meters away.\n\nHeavy Attacks blast enemies in a 6 x 8 area for 92 Shock Damage.\n\nAttacks deplete Ultimate until you run out, or the ability is toggled off.',
      isUltimate: true,
      baseSkillId: ClassSkillId.SORCERER_OVERLOAD,
    },
    {
      ...
      description:
        'Call down lightning to strike an enemy, dealing 3552 Shock Damage.\n\nIf the enemy falls to or below 20% Health within 2 seconds of being struck, an explosion deals an additional 13026 Shock Damage to them and 2688 Shock Damage to other enemies nearby.',
    ...
    },
    {
      ...
      description:
        'Call down lightning to strike an enemy, dealing 3552 Shock Damage.\n\nIf the enemy falls to or below 20% Health within 2 seconds of being struck, an explosion deals an additional 13027 Shock Damage to them and 2689 Shock Damage to other enemies nearby.\n\nIf any enemy is killed within 5 seconds of being hit with this ability, you restore 4860 Magicka.',
      baseSkillId: ClassSkillId.SORCERER_MAGES_FURY,
    },
    {
      ...
      description:
        'Call down lightning to strike an enemy, dealing 3552 Shock Damage.\n\nIf the enemy falls to or below 20% Health within 2 seconds of being struck, an explosion deals an additional 12329 Shock Damage to them and all nearby enemies.',
      baseSkillId: ClassSkillId.SORCERER_MAGES_FURY,
    },
    {
      ...
      description:
        'Manifest yourself as pure lightning, zapping nearby enemies with electricity dealing 1691 Shock Damage every 2 seconds for 20 seconds.\n\nWhile in this form you also gain Major Resolve, increasing your Physical Resistance and Spell Resistance by 5948.',
    ...
    },
    {
      ...
      description:
        'Manifest yourself as pure lightning, zapping nearby enemies with electricity dealing 1690 Shock Damage every 2 seconds for 30 seconds.\n\nWhile in this form you also gain Major Resolve, increasing your Physical Resistance and Spell Resistance by 5948.\n\nActivating this grants you Major Expedition, increasing your Movement Speed by 30% for 4 seconds.',
      baseSkillId: ClassSkillId.SORCERER_LIGHTNING_FORM,
    },
    {
      ...
      description:
        'Manifest yourself as pure air, buffeting nearby enemies with wind dealing 1745 Physical Damage every 2 seconds for 20 seconds. The winds grow in damage and size, increasing up to 120% more damage and up to 9 meters in size.\n\nWhile in this form you gain Major Resolve and Minor Expedition, increasing your Physical and Spell Resistance by 5948 and your Movement Speed by 15%.',
      baseSkillId: ClassSkillId.SORCERER_LIGHTNING_FORM,
      alternateIds: [
    ...
    },
    {
      ...
      description:
        'Create a nexus of storm energy at the target location, dealing 1127 Shock Damage to enemies in the area every 1 second for 10 seconds.\n\nYou or an ally standing within the nexus can activate the Conduit synergy, dealing 10416 Shock Damage to enemies around them.',
    ...
    },
    {
      ...
      description:
        'Create a nexus of storm energy at the target location, dealing 1513 Shock Damage to enemies in the area every 1 second for 10 seconds.\n\nYou or an ally standing within the nexus can activate the Conduit synergy, dealing 10416 Shock Damage to enemies around them.',
      baseSkillId: ClassSkillId.SORCERER_LIGHTNING_SPLASH,
    },
    {
      ...
      description:
        'Create a nexus of storm energy at the target location, dealing 1127 Shock Damage to enemies in the area every 1 second for 15 seconds.\n\nYou or an ally standing within the nexus can activate the Conduit synergy, dealing 10416 Shock Damage to enemies around them.',
      baseSkillId: ClassSkillId.SORCERER_LIGHTNING_SPLASH,
    },
    {
    ...
    },
    {
      ...
      description:
        "Invoke Meridia's name to gain Major Brutality and Sorcery, increasing your Weapon and Spell Damage by 20% for 33 seconds.\n\nWhile active, dealing Critical Damage heals you for 3366 Health. This effect can occur once every 1 second.",
      baseSkillId: ClassSkillId.SORCERER_SURGE,
    },
    {
      ...
      description:
        "Invoke Meridia's name to gain Major Brutality and Major Sorcery, increasing your Weapon Damage and Spell Damage by 20% for 33 seconds.\n\nWhile active, activating a Critical heal causes the ability to heal you and your allies around you for 2601 Health. This effect can occur once every 3 seconds.",
      baseSkillId: ClassSkillId.SORCERER_SURGE,
    },
    {
    ...
    },
    {
      ...
      description:
        'Transform yourself into pure energy and flash forward, dealing 5555 Shock Damage to enemies in your wake and stunning them for 3 seconds.\n\nThis effect cannot be blocked.\n\nCasting again within 4 seconds costs 33% more Magicka.',
      baseSkillId: ClassSkillId.SORCERER_BOLT_ESCAPE,
    },
    {
