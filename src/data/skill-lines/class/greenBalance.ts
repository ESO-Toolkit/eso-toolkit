  ...
  skills: [
    {
      ...
      icon: 'ability_warden_012',
      description:
        'Swell a healing forest at the target location, instantly healing the most injured friendly target for 9818 Health. The forest continues to heal you and your allies in the area for 3271 Health every 1 second for 6 seconds.',
      isUltimate: true,
    ...
    },
    {
      ...
      description:
        'Swell a healing forest at the target location, instantly healing the most injured friendly target for 10142 Health. The forest continues to heal you and your allies in the area for 3379 Health every 1 second for 6 seconds.\n\nYou generate 20 Ultimate if the initial heal is used on a friendly target under 50% Health.',
      isUltimate: true,
      baseSkillId: ClassSkillId.WARDEN_SECLUDED_GROVE,
    },
    {
      ...
      description:
        'Swell a healing forest at the target location, instantly healing the most injured friendly target for 10142 Health. The forest continues to heal you and your allies in the area for 3379 every 1 second for 6 seconds.\n\nThe healing over time will continue to heal you or your allies for 4 seconds after leaving the forest.',
      isUltimate: true,
      baseSkillId: ClassSkillId.WARDEN_SECLUDED_GROVE,
    },
    {
      ...
      description:
        'Seed a large area of mushrooms in front of you, healing you and your allies for 9204 Health.',
    ...
    },
    {
      ...
      description:
        'Summon a field of flowers which blooms after 6 seconds, healing you and allies in the area for 12273 Health.\n\nAn ally within the field can activate the Harvest synergy, healing for 11880 Health over 5 seconds.',
    ...
    },
    {
      ...
      description:
        'Summon a field of flowers which blooms after 6 seconds, healing you and allies in the area for 12274 Health.\n\nWhile the field grows, you and allies are healed for 1447 Health every 1 second.\n\nYou can activate this ability again to cause it to instantly bloom.\n\nAn ally within the field can activate the Harvest synergy, healing for 11880 Health over 5 seconds.',
      baseSkillId: ClassSkillId.WARDEN_HEALING_SEED,
    },
    {
    ...
    },
    {
      ...
      description:
        'Grow vines to embrace you or the lowest health ally in front of you for 10 seconds. The vines heal the target for 2452 Health each time they take damage. This effect can occur once every 1 second.',
    ...
    },
    {
      ...
      description:
        'Grow vines to embrace you or the lowest health ally in front of you for 10 seconds. The vines heal the target for 2535 Health each time they take damage. This effect can occur once every 1 second.\n\nThe vines apply Minor Lifesteal to enemies that damage the target for 10 seconds, healing you and your allies for 612 Health every 1 second when damaging that enemy.',
      baseSkillId: ClassSkillId.WARDEN_LIVING_VINES,
    },
    {
      ...
      description:
        'Grow vines to embrace you or the lowest health ally in front of you for 10 seconds. The vines heal the target for 2535 Health each time they take damage. This effect can occur once every 1 second.\n\nWhen the vines expire, they heal the target for an additional 6136 Health.',
      baseSkillId: ClassSkillId.WARDEN_LIVING_VINES,
    },
    {
      ...
      description:
        'Embrace the lotus blessing, causing your Light Attacks to restore 1346 Health and your fully-charged Heavy Attacks to restore 3097 Health to you or a nearby ally for 20 seconds.\n\nWhile active you gain Major Prophecy and Savagery, increasing your Spell and Weapon Critical rating by 2629.',
    ...
    },
    {
      ...
      description:
        'Embrace the lotus blessing, causing your Light Attacks to restore 1530 Health and your fully-charged Heavy Attacks to restore 3519 Health to you or 2 nearby allies for 20 seconds.\n\nWhile active you gain Major Prophecy and Savagery, increasing your Spell and Weapon Critical rating by 2629.',
      baseSkillId: ClassSkillId.WARDEN_LOTUS_FLOWER,
    },
    {
      ...
      description:
        'Embrace the lotus blessing, causing your Light Attacks to restore 1346 Health and your fully-charged Heavy Attacks to restore 3097 Health to you or a nearby ally for 1 minute.\n\nWhile active you gain Major Prophecy and Savagery, increasing your Spell and Weapon Critical rating by 2629.',
      baseSkillId: ClassSkillId.WARDEN_LOTUS_FLOWER,
    },
    {
      ...
      description:
        'Launch a vine to swing yourself to an ally, healing them for 12270 Health over 10 seconds. You gain 3 Ultimate when this effect completes if you are in combat.',
    ...
    },
    {
      ...
      description:
        'Launch a vine to swing yourself to an ally, healing you and them for 12666 Health over 10 seconds. Gain 3 Ultimate when either of these effects complete while you are in combat.',
      baseSkillId: ClassSkillId.WARDEN_NATURE_S_GRASP,
    },
    {
    ...
    },
    {
      ...
      description:
        'When you overheal yourself or an ally with a Green Balance ability, you gain 125 Magicka and 125 Stamina, up to once every 1 second.',
      isPassive: true,
    },
  ],
};
