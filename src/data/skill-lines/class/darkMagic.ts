  ...
  skills: [
    {
      ...
      icon: 'ability_sorcerer_monsoon',
      description:
        'Create a globe of magic suppression for 9 seconds, removing and preventing all enemy area of effect abilities from occurring in the area.\n\nEnemies within the globe are stunned, while enemy players will be silenced rather than stunned.',
      isUltimate: true,
    ...
    },
    {
      ...
      description:
        'Create a globe of magic suppression for 12 seconds, removing and preventing all enemy area of effect abilities from occurring in the area.\n\nEnemies within the globe are stunned, while enemy players will be silenced rather than stunned.\n\nThe globe also damages enemies for 1005 Magic Damage every 1 second.',
      isUltimate: true,
      baseSkillId: ClassSkillId.SORCERER_NEGATE_MAGIC,
    },
    {
    ...
    },
    {
      ...
      description:
        'Conjure dark crystals to bombard an enemy, dealing 2404 Magic Damage. Your next non-Ultimate ability cast within 3 seconds costs 10% less.\n\nWhile slotted on either bar, casting a non-Ultimate ability has a 33% chance of causing your next Crystal Fragments to be instant cast at half cost, dealing 3992 Magic Damage.',
      baseSkillId: ClassSkillId.SORCERER_CRYSTAL_SHARD,
    },
    {
    ...
    },
    {
      ...
      description:
        'Call forth Daedric shards from the earth to encase and immobilize all enemies in front of you for 4 seconds. After the effect ends the shards shatter, dealing 1916 Magic Damage to any enemy that was encased.\n\nEnemies hit are afflicted with Major Maim, reducing their damage done by 10% for 10 seconds.',
      baseSkillId: ClassSkillId.SORCERER_ENCASE,
    },
    {
    ...
    },
    {
      ...
      description:
        'Place a rune of protection on yourself for 1 minute. While active, the next enemy to attack you is imprisoned in a constricting sphere of dark magic, stunning them after a short delay for 3 seconds.\n\nThis stun cannot be blocked.',
      baseSkillId: ClassSkillId.SORCERER_RUNE_PRISON,
    },
    {
      ...
      description:
        'Imprison an enemy in a constricting sphere of dark magic. After a short duration they are stunned for 3 seconds. Deals 1742 Magic Damage if the stun lasts the full duration.\n\nThis stun cannot be blocked.',
      baseSkillId: ClassSkillId.SORCERER_RUNE_PRISON,
    },
    {
      ...
      description:
        'Bargain with darkness to restore 7700 Health and 3600 Magicka instantly, and an additional 2400 Magicka over 20 seconds. \n\nThe exchange also grants you Minor Berserk for 20 seconds, increasing your damage done by 5%.',
    ...
    },
    {
      ...
      description:
        'Bargain with darkness to restore 9700 Health and 4200 Magicka instantly, and an additional 2850 Magicka over 20 seconds.\n\nThe exchange also grants you Minor Berserk for 20 seconds, increasing your damage done by 5%.',
      baseSkillId: ClassSkillId.SORCERER_DARK_EXCHANGE,
    },
    {
    ...
    },
    {
      ...
      description:
        'Surprise your foes by placing 3 volatile Daedric mines around you, which take 3 seconds to arm and last for 15 seconds.\n\nWhen a mine is triggered it explodes, dealing 2530 Magic Damage and immobilizing the enemy for 2 seconds. Enemies can only be damaged by your mines once every 2 seconds.',
    ...
    },
    {
      ...
      description:
        'Surprise your foes by placing 3 volatile Daedric mines at a target location, which arm instantly and last for 15 seconds.\n\nWhen a mine is triggered it explodes, dealing 2614 Magic Damage and immobilizing the enemy for 2 seconds. Enemies can only be damaged by your mines once every 2 seconds.',
      baseSkillId: ClassSkillId.SORCERER_DAEDRIC_MINES,
    },
    {
