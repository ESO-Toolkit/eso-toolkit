...
export const heraldOfTheTome: SkillLineData = {
  ...
  skills: [
    ...
    },
    {
      ...
      description:
        'Infuse your arm with abyssal magic to form tentacles that lash out at your foes, dealing 1939 Physical Damage. Enemies are immobilized for 3 seconds and marked with Abyssal Ink for 17 seconds.\n\nYou deal 5% increased damage to enemies drenched in Abyssal Ink.',
    ...
    },
    {
      ...
      description:
        'Infuse your arm with abyssal magic to form tentacles that lash out at your foes, dealing 1939 Frost Damage. Enemies are immobilized for 3 seconds and marked with Abyssal Ink for 20 seconds.\n\nYou deal 5% increased damage to enemies drenched in Abyssal Ink.\n\nConsume all Crux and increase Tentacular Dread damage by 33% and damage to foes drenched in Abyssal Ink by 2% per Crux spent.',
      baseSkillId: ClassSkillId.ARCANIST_ABYSSAL_IMPACT,
    },
    {
      ...
      description:
        'Craft a series of Apocryphal runes before launching them at a foe, dealing 673 Magic Damage three times and generating Crux.\n\nThis ability deals 3% increased damage for each active Crux when cast.',
    ...
    },
    {
      ...
      description:
        'Craft a series of Apocryphal runes before launching them at a foe, dealing 696 Magic Damage, 766 Magic Damage, and 842 Magic Damage and generating Crux. The last rune explodes, dealing damage to all enemies within 8 meters of the target.\n\nThis ability deals 3% increased damage for each active Crux when cast.',
      baseSkillId: ClassSkillId.ARCANIST_RUNEBLADES,
      alternateIds: [188780],
    },
    {
    ...
    },
    {
      ...
      description:
        'Harness pure knowledge into a beam of energy that scars the world in front of you. Channel the beam for up to 4 seconds, dealing 851 Magic Damage every 0.3 seconds to up to 6 enemies.\n\nCasting Fatecarver consumes all Crux and increases damage done by 33% per Crux spent.\n\nThis ability is considered direct damage.',
    ...
    },
    {
      ...
      description:
        'Harness pure knowledge into a beam of energy that scars the world in front of you. Channel the beam for up to 4 seconds, dealing 879 Magic Damage every 0.3 seconds to up to 6 enemies and snares them by 12%.\n\nCasting Exhausting Fatecarver consumes all Crux and increases damage done by 33%, duration by 0.3 seconds, and snare by 12% per Crux spent.\n\nThis ability is considered direct damage.',
      baseSkillId: ClassSkillId.ARCANIST_FATECARVER,
    },
    {
    ...
    },
    {
      ...
      description:
        'Summon a flawed rune under an enemy that etches foes nearby with scrawled glyphs, dealing 4488 Magic Damage over 20 seconds.\n\nAn ally near the initial target can activate the Runebreak synergy, dealing 2698 Frost Damage to enemies within 7 meters.',
    ...
    },
    {
      ...
      description:
        'Summon a discharging rune under an enemy. After 2 seconds the rune pulses, pulling in foes between 2 to 10 meters and etching them with scrawled glyphs that deal 4630 Magic Damage over 18 seconds.\n\nAn ally near the initial target can activate the Runebreak synergy, dealing 2698 Frost Damage to enemies within 7 meters.',
      baseSkillId: ClassSkillId.ARCANIST_THE_IMPERFECT_RING,
    },
    {
    ...
    },
    {
      ...
      description:
        'Etch a series of runes onto your weapon that pulse with power once every 3 seconds. Each pulse enhances your class abilities, and striking an enemy with one deals an additional 906 Magic Damage and generates Crux if you have none.\n\nWhile slotted on either ability bar, gain Major Brutality and Major Sorcery, increasing your Weapon and Spell Damage by 20%.',
      baseSkillId: ClassSkillId.ARCANIST_TOME_BEARER_S_INSPIRATION,
    },
    {
      ...
      description:
        'Etch a series of runes onto your weapon that pulse with power once every 5 seconds. Each pulse enhances your class abilities, and striking an enemy with one deals an additional 1161 Magic Damage, restores 510 Magicka and Stamina, and generates Crux if you have none.\n\nWhile slotted on either ability bar, gain Major Brutality and Major Sorcery, increasing your Weapon and Spell Damage by 20%.',
      baseSkillId: ClassSkillId.ARCANIST_TOME_BEARER_S_INSPIRATION,
    },
    {
