  ...
  skills: [
    {
      ...
      icon: 'ability_arcanist_006',
      description:
        "Tear open the fabric of the Aurbis to summon a scion of Hermaeus Mora. This being casts forth a beam that rends asunder reality for 6 seconds and deals 4059 Magic Damage to enemies within 5 meters every 0.5 seconds.\n\nThe scion's beam can be repositioned by recasting The Unblinking Eye.",
      isUltimate: true,
    ...
    },
    {
      ...
      description:
        "Tear open the fabric of the Aurbis to summon a scion of Hermaeus Mora. This being casts forth a beam that rends asunder reality for 8 seconds that deals 4445 Magic Damage to enemies within 5 meters every 0.5 seconds.\n\nThe scion's beam automatically follows the initial target, and hunts for a new one within 8 meters if it is slain.",
      isUltimate: true,
      baseSkillId: ClassSkillId.ARCANIST_THE_UNBLINKING_EYE,
    },
    {
      ...
      description:
        'Infuse your arm with abyssal magic to form tentacles that lash out at your foes, dealing 7486 Physical Damage. Enemies are immobilized for 3 seconds and marked with Abyssal Ink for 20 seconds.\n\nYou deal 5% increased damage to enemies drenched in Abyssal Ink.',
    ...
    },
    {
      ...
      description:
        'Infuse your arm with abyssal magic to form tentacles that lash out at your foes dealing 7486 Physical Damage and generating Crux. Enemies are immobilized for 3 seconds and marked with Abyssal Ink for 20 seconds.\n\nIf an enemy is hit, you for heal for 3527 Health, once per cast.\n\nYou deal 5% increased damage to enemies drenched in Abyssal Ink.',
      baseSkillId: ClassSkillId.ARCANIST_ABYSSAL_IMPACT,
    },
    {
      ...
      description:
        'Infuse your arm with abyssal magic to form tentacles that lash out at your foes, dealing 7733 Frost Damage. Enemies are immobilized for 3 seconds and marked with Abyssal Ink for 20 seconds.\n\nYou deal 5% increased damage to enemies drenched in Abyssal Ink.\n\nConsume all Crux and increase Tentacular Dread damage by 33% and damage to foes drenched in Abyssal Ink by 2% per Crux spent.',
      baseSkillId: ClassSkillId.ARCANIST_ABYSSAL_IMPACT,
    },
    {
      ...
      description:
        'Craft a series of Apocryphal runes before launching them at a foe, dealing 2840 Magic Damage three times and generating Crux.\n\nThis ability deals 3% increased damage for each active Crux when cast.',
    ...
    },
    {
      ...
      description:
        'Craft a series of Apocryphal runes before launching them at a foe, dealing 2841 Magic Damage, 3126 Magic Damage, and 3547 Magic Damage and generating Crux. The last rune explodes, dealing damage to all enemies within 8 meters of the target.\n\nThis ability deals 3% increased damage for each active Crux when cast.',
      baseSkillId: ClassSkillId.ARCANIST_RUNEBLADES,
      alternateIds: [188780],
    },
    {
    ...
    },
    {
      ...
      description:
        'Harness pure knowledge into a beam of energy that scars the world in front of you. Channel the beam for up to 4 seconds, dealing 3393 Magic Damage every 0.3 seconds to up to 6 enemies.\n\nCasting Fatecarver consumes all Crux and increases damage done by 33% per Crux spent.\n\nThis ability is considered direct damage.',
    ...
    },
    {
      ...
      description:
        'Harness pure knowledge into a beam of energy that scars the world in front of you. Channel the beam for up to 4 seconds, dealing 3393 Magic Damage every 0.3 seconds to up to 6 enemies and snares them by 15%.\n\nCasting Exhausting Fatecarver consumes all Crux and increases damage done by 33%, duration by 0.3 seconds, and snare by 15% per Crux spent.\n\nThis ability is considered direct damage.',
      baseSkillId: ClassSkillId.ARCANIST_FATECARVER,
    },
    {
      ...
      description:
        'Channel a beam of energy in front of you for up to 4 seconds, dealing 3393 Magic Damage every 0.3 seconds to up to 6 enemies, and gain a damage shield that absorbs up to 9200 damage and grants interrupt immunity.\n\nCasting Pragmatic Fatecarver consumes all Crux and increases damage done by 33%, and decreases cost by 16% per Crux spent.\n\nThis ability is considered direct damage.',
      baseSkillId: ClassSkillId.ARCANIST_FATECARVER,
      alternateIds: [193398],
    },
    {
      ...
      description:
        'Summon a flawed rune under an enemy that etches foes nearby with scrawled glyphs, dealing 17919 Magic Damage over 20 seconds.\n\nAn ally near the initial target can activate the Runebreak synergy, dealing 10416 Frost Damage to enemies within 7 meters.',
    ...
    },
    {
      ...
      description:
        'Summon an explosive rune under an enemy that etches foes nearby with scrawled glyphs, dealing 17919 Magic Damage over 20 seconds.\n\nThe rune lingers on the initial target for 6 seconds before detonating, dealing 5555 Frost Damage to enemies within 7 meters. Rune detonation cannot be primed with Fulminating Rune again for 6 seconds.\n\nUp to 3 allies near the initial target can activate the Runebreak synergy, dealing 10416 Frost Damage to enemies within 7 meters.',
      baseSkillId: ClassSkillId.ARCANIST_THE_IMPERFECT_RING,
    },
    {
      ...
      description:
        'Summon a discharging rune under an enemy. After 2 seconds the rune pulses, pulling in foes between 2 to 10 meters and etching them with scrawled glyphs that deal 18500 Magic Damage over 18 seconds.\n\nAn ally near the initial target can activate the Runebreak synergy, dealing 10416 Frost Damage to enemies within 7 meters.',
      baseSkillId: ClassSkillId.ARCANIST_THE_IMPERFECT_RING,
    },
    {
      ...
      description:
        'Etch a series of runes onto your weapon that pulse with power once every 5 seconds. Each pulse enhances your class abilities, and striking an enemy with one deals an additional 4736 Magic Damage and generates Crux if you have none.\n\nWhile slotted on either ability bar, gain Major Brutality and Major Sorcery, increasing your Weapon and Spell Damage by 20%.',
    ...
    },
    {
      ...
      description:
        'Etch a series of runes onto your weapon that pulse with power once every 3 seconds. Each pulse enhances your class abilities, and striking an enemy with one deals an additional 3815 Magic Damage and generates Crux if you have none.\n\nWhile slotted on either ability bar, gain Major Brutality and Major Sorcery, increasing your Weapon and Spell Damage by 20%.',
      baseSkillId: ClassSkillId.ARCANIST_TOME_BEARER_S_INSPIRATION,
    },
    {
      ...
      description:
        'Etch a series of runes onto your weapon that pulse with power once every 5 seconds. Each pulse enhances your class abilities, and striking an enemy with one deals an additional 4736 Magic Damage, restores 600 Magicka and Stamina, and generates Crux if you have none.\n\nWhile slotted on either ability bar, gain Major Brutality and Major Sorcery, increasing your Weapon and Spell Damage by 20%.',
      baseSkillId: ClassSkillId.ARCANIST_TOME_BEARER_S_INSPIRATION,
    },
    {
    ...
    },
    {
      ...
      description:
        'You master the warp and weft of your very soul.\n\nWhen you restore Magicka or Stamina, your Weapon and Spell Damage increase by 284 for 10 seconds.',
      isPassive: true,
    },
    {
