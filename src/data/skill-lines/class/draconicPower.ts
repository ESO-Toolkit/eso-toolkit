  ...
  skills: [
    {
      ...
      icon: 'ability_dragonknight_009',
      description:
        'Launch yourself at an enemy, dealing 13793 Flame Damage to all enemies in the area, knocking players back 4 meters and stunning them for 2 seconds. If the target is a monster they are instead knocked into the air and stunned for 3 seconds.',
      isUltimate: true,
    ...
    },
    {
      ...
      description:
        'Launch yourself at an enemy, dealing 13794 Flame Damage to all enemies in the area, knocking players back 4 meters and stunning them for 2 seconds. If the target is a monster they are instead knocked into the air and stunned for 3 seconds.\n\nUpon activation you gain a damage shield that absorbs 19749 damage for 10 seconds. This portion of the ability scales with your Max Health.',
      isUltimate: true,
      baseSkillId: ClassSkillId.DRAGONKNIGHT_DRAGON_LEAP,
    },
    {
      ...
      description:
        "Launch yourself at an enemy, dealing 15841 Flame Damage to all enemies in the area, knocking them back 4 meters, and stunning them for 2 seconds. If the target is a monster they are instead knocked into the air and stunned for 3 seconds.\n\nUpon activation you are filled with draconic fury for 15 seconds, increasing your damage done by 10%. This effect's potency doubles against monsters.",
      isUltimate: true,
      baseSkillId: ClassSkillId.DRAGONKNIGHT_DRAGON_LEAP,
    },
    {
      ...
      description:
        'Exhale a blast of draconic fire in front of you, dealing 6724 Flame Damage and an additional 11205 Flame Damage over 10 seconds to enemies in your path.',
    ...
    },
    {
      ...
      description:
        'Exhale a blast of draconic fire in front of you, dealing 6946 Flame Damage, applying the Burning status effect, and an additional 11570 Flame Damage over 10 seconds to enemies in your path.\n\nThe initial hit liquifies the armor of your enemies, applying Major Breach to enemies for the duration, reducing Physical and Spell Resistance by 5948.',
      baseSkillId: ClassSkillId.DRAGONKNIGHT_FIERY_BREATH,
    },
    {
    ...
    },
    {
      ...
      description:
        'Lash out with a flaming chain, pulling an enemy to you. The searing metal deals 5683 Flame Damage, applies the Burning status effect, and taunts them for 15 seconds if they are not already taunted.\n\nThis attack cannot be dodged or reflected.\n\nAlso inflicts Major Cowardice on the enemy, reducing Weapon and Spell Damage by 430 for 10 seconds.',
    ...
    },
    {
      ...
      description:
        "Lash out with a chain bound in Draconic runes, pulling an enemy to you. The enchanted metal deals 5683 Flame Damage, applies the Burning status effect, and taunts them for 15 seconds if they are not already taunted. If the target cannot be pulled, you restore the ability's Magicka cost.\n\nThis attack cannot be dodged or reflected.\n\nAlso inflicts Major Cowardice on the enemy, reducing Weapon and Spell Damage by 430 for 15 seconds.",
      baseSkillId: ClassSkillId.DRAGONKNIGHT_FIERY_GRIP,
    },
    {
    ...
    },
    {
      ...
      description:
        'Call forth talons from the ground, dealing 6724 Flame Damage to enemies near you and immobilizing them for 4 seconds.\n\nAn ally near the talons can activate the Ignite synergy, dealing 10850 Flame Damage to all enemies held within them.',
    ...
    },
    {
      ...
      description:
        'Call forth talons from the ground, dealing 6946 Flame Damage to enemies near you, an additional 6325 Flame Damage over 5 seconds, and immobilizing them for 4 seconds.\n\nAn ally near the talons can activate the Ignite synergy, dealing 10850 Flame Damage to all enemies held within them.',
      baseSkillId: ClassSkillId.DRAGONKNIGHT_DARK_TALONS,
    },
    {
      ...
      description:
        'Call forth talons from the ground, dealing 6725 Flame Damage to enemies near you and immobilizing them for 4 seconds.\n\nEnemies hit are afflicted with Minor Maim, reducing damage done by 5% for 20 seconds.\n\nAn ally near the talons can activate the Ignite synergy, dealing 10850 Flame Damage to all enemies held within them.',
      baseSkillId: ClassSkillId.DRAGONKNIGHT_DARK_TALONS,
    },
    {
      ...
      description:
        'Draw on your draconic blood to heal for 4846 Health, increasing by up to 50% additional healing based on your missing Health. This ability scales off your Max Health.\n\nYou also gain Major Fortitude, increasing your Health Recovery by 30% for 20 seconds.',
    ...
    },
    {
      ...
      description:
        'Draw on your draconic blood to heal for 4846 Health, increasing by up to 50% additional healing based on your missing Health. Heals for an additional 3000 Health over 5 seconds. This ability scales off your Max Health.\n\nYou also gain Major Endurance and Fortitude and Minor Vitality, increasing Health and Stamina Recovery by 30% and increasing healing received and damage shield strength by 6% for 20 seconds.',
      baseSkillId: ClassSkillId.DRAGONKNIGHT_DRAGON_BLOOD,
    },
    {
      ...
      description:
        'Draw on your draconic blood to heal yourself for 10564 and nearby allies for 7042 Health, increasing by up to 50% additional healing based on missing Health.\n\nHealed targets gain Major Fortitude and Minor Courage, increasing Health Recovery by 30% and Weapon and Spell Damage by 215 for 20 seconds.',
      baseSkillId: ClassSkillId.DRAGONKNIGHT_DRAGON_BLOOD,
    },
    {
