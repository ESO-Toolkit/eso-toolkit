...
export const ardentFlame: SkillLineData = {
  ...
  skills: [
    ...
    },
    {
      ...
      description:
        'Call down a battle standard, dealing 3275 Flame Damage every 1 second for 25 seconds to enemies and applying Major Defile to them, reducing their healing received and damage shield strength by 12%.\n\nActivating this ability again allows you to move the standard to your location.\n\nAn ally near the standard can activate the Shackle synergy, dealing 13020 Flame Damage to enemies in the area and immobilizing them for 5 seconds.',
      isUltimate: true,
      baseSkillId: ClassSkillId.DRAGONKNIGHT_DRAGONKNIGHT_STANDARD,
    },
    {
    ...
    },
    {
      ...
      description:
        'Slash your foe with a fiery claw, dealing 4736 Flame Damage and an additional 13440 Flame Damage over 10 seconds.\n\nThe initial hit always applies the Burning status effect.',
    ...
    },
    {
      ...
      description:
        'Slash your foe with a fiery claw, dealing 4736 Flame Damage and an additional 13445 Flame Damage over 10 seconds.\n\nThe flame sears into the target, dealing 10% more damage every 2 seconds.\n\nThe initial hit always applies the Burning status effect.',
      baseSkillId: ClassSkillId.DRAGONKNIGHT_SEARING_STRIKE,
    },
    {
      ...
      description:
        'Slash your foe with a fiery claw, dealing 4736 Flame Damage and an additional 13445 Flame Damage over 10 seconds.\n\nYou heal for 4005 Health from the initial hit and 600 Health each subsequent tick, scaling off your Max Health.\n\nThe initial hit always applies the Burning status effect.',
      baseSkillId: ClassSkillId.DRAGONKNIGHT_SEARING_STRIKE,
    },
    {
    ...
    },
    {
      ...
      description:
        'Let the fire within draw heat to your heart, restoring 15% of your missing Magicka and Stamina and healing 3004 Health every 2 seconds over 4 seconds.\n\nWhen this ability completes, you release this heat as a blast of fire that deals 7733 Flame Damage to nearby enemies.',
      baseSkillId: ClassSkillId.DRAGONKNIGHT_INHALE,
    },
    {
    ...
    },
    {
      ...
      description:
        'Lash an enemy with flame, dealing 9473 Flame Damage.\n\nHitting an Off Balance enemy grants 5 stacks of Volcanic Whip for 20 seconds, up to once every 20 seconds.\n\nVolcanic Whip replaces this ability and consumes a stack to instead deal 16736 Flame Damage to your target and all nearby enemies.',
    ...
    },
    {
      ...
      description:
        'Lash an enemy with flame, dealing 9473 Flame Damage and healing for 2816 Health.\n\nHitting an Off Balance enemy grants 5 stacks of Power Lash for 20 seconds, up to once every 20 seconds.\n\nActivating again consumes a stack to deal 16737 Flame Damage to your target and all nearby enemies and heals for 11269 Health.',
      baseSkillId: ClassSkillId.DRAGONKNIGHT_LAVA_WHIP,
    },
    {
      ...
      description:
        'Activate an aura of flames which launches a wave of flame around you every 5 seconds, dealing 6724 Flame Damage to enemies inside.\n\nWhile slotted on either bar, you gain Major Prophecy and Savagery, increasing your Spell and Weapon Critical rating by 2629.',
    ...
    },
    {
      ...
      description:
        'Activate an aura of flames which launches a wave of flames every 5 seconds, dealing 7640 Flame Damage to enemies inside.\n\nEach hit has a 15% chance of applying Burning.\n\nWhile slotted on either bar, you gain Major Prophecy and Savagery, increasing your Spell and Weapon Critical rating by 2629.',
      baseSkillId: ClassSkillId.DRAGONKNIGHT_INFERNO,
    },
    {
      ...
      description:
        'Activate an aura of embers which cauterizes the wounds of you or up to 6 nearby allies every 3 seconds, healing for 4225 Health.\n\nWhile slotted on either bar, you gain Major Prophecy and Savagery, increasing your Spell and Weapon Critical rating by 2629.',
      baseSkillId: ClassSkillId.DRAGONKNIGHT_INFERNO,
    },
    {
    ...
    },
    {
      ...
      description:
        'Tend to your garden of flame, that it may flourish.\n\nIncreases your chances of applying the Burning status effect by 30% and its damage done by 15%. These values are influenced by the number of Dragonknight abilities slotted.',
      isPassive: true,
    },
    {
