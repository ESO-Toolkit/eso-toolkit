...
export const clothing: SkillLineData = {
  ...
  category: 'craft',
  skills: [
    { id: AbilityId.TAILORING, icon: 'ability_tradecraft_002', name: 'Tailoring', isPassive: true, isUltimate: false, maxRank: 3 },
    {
    ...
    { id: AbilityId.STITCHING, icon: 'crafting_light_armor_component_004', name: 'Stitching', isPassive: true, isUltimate: false, maxRank: 3 },
    {
