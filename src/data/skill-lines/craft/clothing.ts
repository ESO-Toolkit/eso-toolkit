...
export const clothing: SkillLineData = {
  ...
  category: 'craft',
  skills: [
    { id: AbilityId.TAILORING, alternateIds: [47288, 47289, 47290, 47291, 47292, 47293, 48188, 48189, 70044], icon: 'ability_tradecraft_002', name: 'Tailoring', isPassive: true, isUltimate: false, maxRank: 3 },
    {
    ...
    { id: AbilityId.STITCHING, alternateIds: [48191, 48192, 58782], icon: 'crafting_light_armor_component_004', name: 'Stitching', isPassive: true, isUltimate: false, maxRank: 3 },
    {
