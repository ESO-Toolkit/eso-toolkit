...
export const provisioning: SkillLineData = {
  ...
  skills: [
    ...
    { id: AbilityId.GOURMAND, icon: 'ability_provisioner_004', name: 'Gourmand', isPassive: true, isUltimate: false, maxRank: 3 },
    {
    ...
    { id: AbilityId.CHEF, icon: 'ability_provisioner_002', name: 'Chef', isPassive: true, isUltimate: false, maxRank: 3 },
    { id: AbilityId.BREWER, icon: 'ability_provisioner_003', name: 'Brewer', isPassive: true, isUltimate: false, maxRank: 3 },
    {
