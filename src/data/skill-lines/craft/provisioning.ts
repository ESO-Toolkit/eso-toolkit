...
export const provisioning: SkillLineData = {
  ...
  name: 'Provisioning',
  skills: [
    { id: AbilityId.RECIPE_QUALITY, name: 'Recipe Quality', isPassive: true, isUltimate: false, maxRank: 4 },
    { id: AbilityId.RECIPE_IMPROVEMENT, name: 'Recipe Improvement', isPassive: true, isUltimate: false, maxRank: 3 },
    { id: AbilityId.GOURMAND, name: 'Gourmand', isPassive: true, isUltimate: false, maxRank: 3 },
    { id: AbilityId.CONNOISSEUR, name: 'Connoisseur', isPassive: true, isUltimate: false, maxRank: 3 },
    ...
    { id: AbilityId.FORAGER_HIRELING, name: 'Forager Hireling', isPassive: true, isUltimate: false, maxRank: 3 },
  ],
};
