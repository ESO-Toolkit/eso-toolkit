...
export const provisioning: SkillLineData = {
  ...
  skills: [
    ...
    { id: AbilityId.GOURMAND, alternateIds: [44609, 44610], icon: 'ability_provisioner_004', name: 'Gourmand', isPassive: true, isUltimate: false, maxRank: 3 },
    {
    ...
    { id: AbilityId.CHEF, alternateIds: [44617, 44619], icon: 'ability_provisioner_002', name: 'Chef', isPassive: true, isUltimate: false, maxRank: 3 },
    { id: AbilityId.BREWER, alternateIds: [44621, 44624], icon: 'ability_provisioner_003', name: 'Brewer', isPassive: true, isUltimate: false, maxRank: 3 },
    {
