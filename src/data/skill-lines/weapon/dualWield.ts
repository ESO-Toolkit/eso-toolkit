...
export const dualWieldSkillLine: SkillLineData = {
  ...
  skills: [
    // Ultimate Abilities
    {
      ...
      description:
        'Slash enemies in front of you, causing them to bleed for 26890 Bleed Damage over 8 seconds and healing you for 51% of the damage done.\n\nEach tick applies the Hemorrhaging status effect.',
    },
    {
      id: 83600, // Rend (morph)
      name: 'Rend',
    ...
    // Active Abilities
    {
      ...
      description:
        'Flood an enemy with steel, battering them with four consecutive attacks that each deal 2723 Physical Damage.',
    },
    {
      ...
      baseAbilityId: AbilityId.FLURRY,
      description:
        'Flood an enemy with steel, battering them with four consecutive attacks that each deal 2812 Bleed Damage and heal you for 34% of the damage caused.',
    },
    {
      ...
      baseAbilityId: AbilityId.FLURRY,
      description:
        'Flood an enemy with steel, battering them with four consecutive attacks that each deal 2812 Physical Damage.\n\nEach hit increases the damage of the subsequent hit by 5%.',
    },
    {
      ...
      description:
        'Slice an enemy with both weapons to cause deep lacerations, dealing 2368 Bleed Damage with each weapon and causing them to bleed for an additional 13430 Bleed Damage over 20 seconds.',
    },
    {
      ...
      baseAbilityId: AbilityId.TWIN_SLASHES,
      description:
        'Slice an enemy with both weapons to cause deep lacerations, dealing 2368 Bleed Damage with each weapon and causing them to bleed for an additional 13440 Bleed Damage over 20 seconds.\n\nYou heal for 1267 Health anytime this ability deals damage.',
    },
    {
      ...
      baseAbilityId: AbilityId.TWIN_SLASHES,
      description:
        'Slice an enemy with both weapons to cause deep lacerations, dealing 2934 Bleed Damage with each weapon and causing them to bleed for an additional 13440 Bleed Damage over 20 seconds.\n\nEnemies hit by the initial hit are afflicted with the Hemorrhaging status effect.\n\nYou also reduce their Movement Speed by 30% for 4 seconds.',
    },
    {
      ...
      description:
        'Launch yourself into a lethal spin, dealing 6724 Physical Damage to nearby enemies. Deals up to 33% more damage to enemies with less than 50% Health.',
      alternateIds: [28591],
    },
    {
      ...
      baseAbilityId: AbilityId.WHIRLWIND,
      description:
        'Launch yourself into a lethal spin, dealing 6946 Physical Damage to nearby enemies. Deals up to 100% more damage to enemies with less than 50% Health.',
    },
    {
    ...
    },
    {
      ...
      baseAbilityId: AbilityId.BLADE_CLOAK,
      description:
        'Fire a secret dagger from your sleeve at an enemy, dealing 5870 Physical Damage and marking them for 5 seconds.\n\nIf the enemy hit is casting an ability they are interrupted, set Off Balance, and stunned for 3 seconds.\n\nReactivating this ability on them allows you to jump to a marked enemy free of cost, dealing 8808 Physical Damage.\n\nCasting grants you Major Brutality and Sorcery, increasing your Weapon and Spell Damage by 20% for 40 seconds.',
      alternateIds: [38906],
    },
    {
    ...
    },
    {
      ...
      description:
        'Fire a secret dagger from your sleeve at an enemy, dealing 5683 Physical Damage and granting you Major Brutality and Sorcery, increasing your Weapon and Spell Damage by 20% for 20 seconds.\n\nIf the enemy hit is casting an ability they are interrupted, set Off Balance, and stunned for 3 seconds.',
    },
    {
