...
export const restorationStaff: SkillLineData = {
  ...
  skills: [
    // Ultimate abilities
    {
      ...
      description:
        'Release the rejuvenating energies of your staff to swirl around you, healing you or an ally for 10228 Health every 1 second for 5 seconds.',
    },
    {
    ...
    },
    {
      ...
      baseAbilityId: AbilityId.PANACEA,
      description:
        'Release the rejuvenating energies of your staff to swirl around you, healing you or a nearby ally for 10228 Health every 1 second for 5 seconds.\n\nAny friendly target you heal gains Major Force for 8 seconds, increasing their Critical Damage by 20%.',
    },
    // Scribing abilities
    {
    ...
    // Active abilities - Grand Healing family
    {
      ...
      description:
        'Summon restoring spirits with your staff, healing you and your allies in the target area for 16346 Health over 10 seconds.',
    },
    {
      ...
      baseAbilityId: AbilityId.GRAND_HEALING,
      description:
        'Summon restoring spirits with your staff, healing you and your allies in the target area for 16357 Health over 10 seconds.\n\nIncreases your Magicka Recovery by 15 for each target affected, stacking up to 20 times.',
    },
    {
      ...
      baseAbilityId: AbilityId.GRAND_HEALING,
      description:
        'Summon restoring spirits with your staff, healing you and your allies in the target area for 19331 Health over 15 seconds.',
    },
    // Active abilities - Regeneration family
    {
      ...
      description:
        "Share your staff's life-giving energy, healing you or a nearby ally for 12270 Health over 10 seconds.",
    },
    {
      ...
      baseAbilityId: AbilityId.REGENERATION,
      description:
        "Share your staff's life-giving energy, healing you or up to 3 nearby allies for 12666 over 10 seconds.",
    },
    {
      ...
      baseAbilityId: AbilityId.REGENERATION,
      description:
        "Share your staff's life-giving energy, healing you or a nearby ally for 12666 Health over 5 seconds.\n\nThe healing increases by up to 50% more on targets under 100% Health.",
    },
    ...
    // Active abilities - Steadfast Ward family
    {
      ...
      description:
        "Call on your staff's strength to protect you or the lowest health ally around you with a damage shield that absorbs 8021 damage for 6 seconds.\n\nThe shield's strength is increased by up to 100%, depending on the severity of the target's wounds.",
    },
    {
      ...
      baseAbilityId: AbilityId.STEADFAST_WARD,
      description:
        "Call on your staff's strength to protect you or the lowest health ally around you with a damage shield that absorbs 8285 damage.\n\nThe shield's strength is increased by up to 100%, depending on the severity of the target's wounds.\n\nWhile the shield persists, the target is healed for 34% of the shield's remaining strength every second.",
    },
    {
      ...
      baseAbilityId: AbilityId.STEADFAST_WARD,
      description:
        "Call on your staff's strength to protect you and the lowest health ally around you with a damage shield that absorbs 8021 damage.\n\nThe shield's strength is increased by up to 100%, depending on the severity of the target's wounds.",
    },
    // Active abilities - Force Siphon family
    {
      ...
      description:
        "Focus your staff's power to apply Minor Lifesteal to an enemy for 24 seconds, healing you and your allies for 612 Health every 1 second when damaging them.",
    },
    {
      ...
      baseAbilityId: AbilityId.FORCE_SIPHON,
      description:
        "Focus your staff's power to apply Minor Lifesteal to an enemy for 30 seconds, healing you and your allies for 612 Health every 1 second when damaging them.\n\nWhen you or an ally hits the target, they gain Minor Expedition, which increases their Movement Speed by 15% for 4 seconds.",
    },
    {
    ...
    // Passive abilities
    {
      ...
      description:
        'You gain Major Mending for 2 seconds after completing a fully-charged Heavy Attack, increasing your healing done by 16%.\n\nYou also heal yourself or an ally within 12 meters of the target for 26% of the damage inflicted by the final hit of a fully-charged Heavy Attack.',
    },
    {
