...
export const belharzasBand: GearSetData = {
...
export const cryptcanonVestments: GearSetData = {
...
export const deathDealersFete: GearSetData = {
  name: "Death Dealer's Fete",
  icon: "Death Dealer's Fete",
  setType: 'Mythic',
  bonuses: [
...
export const dovRhaSabatons: GearSetData = {
...
export const esotericEnvironmentGreaves: GearSetData = {
  name: 'Esoteric Environment Greaves',
  icon: 'Esoteric Environment Greaves',
  setType: 'Mythic',
  bonuses: [
...
export const faunsLarkCladding: GearSetData = {
...
export const gazeOfSithis: GearSetData = {
  name: 'Gaze of Sithis',
  icon: 'Gaze of Sithis',
  setType: 'Mythic',
  bonuses: [
...
export const madGodsDancingShoes: GearSetData = {
...
export const malacathsBandOfBrutality: GearSetData = {
  name: "Malacath's Band of Brutality",
  icon: "Malacath's Band of Brutality",
  setType: 'Mythic',
  bonuses: [
...
export const markynRingOfMajesty: GearSetData = {
  name: 'Markyn Ring of Majesty',
  icon: 'Markyn Ring of Majesty',
  setType: 'Mythic',
  bonuses: [
    '(1 item) Gain 100 Weapon and Spell Damage and 1157 Armor for every set you are wearing 3 or more pieces of.',
  ],
};

export const monomythReforged: GearSetData = {
...
export const morasWhispers: GearSetData = {
...
export const oakensoulRing: GearSetData = {
  name: 'Oakensoul Ring',
  icon: 'Oakensoul Ring',
  setType: 'Mythic',
  bonuses: [
...
export const pearlsOfEhlnofey: GearSetData = {
  name: 'Pearls of Ehlnofey',
  icon: 'Pearls of Ehlnofey',
  setType: 'Mythic',
  bonuses: [
...
export const rakkhatsVoidmantle: GearSetData = {
...
export const ringOfThePaleOrder: GearSetData = {
  name: 'Ring of the Pale Order',
  icon: 'Ring of the Pale Order',
  setType: 'Mythic',
  bonuses: [
...
export const ringOfTheWildHunt: GearSetData = {
  name: 'Ring of the Wild Hunt',
  icon: 'Ring of the Wild Hunt',
  setType: 'Mythic',
  bonuses: [
...
export const rourkenSteamguards: GearSetData = {
...
export const seaSerpentsCoil: GearSetData = {
...
export const shapeshiftersChain: GearSetData = {
  name: "Shapeshifter's Chain",
  icon: "Shapeshifter's Chain",
  setType: 'Mythic',
  bonuses: [
...
export const snowTreaders: GearSetData = {
  name: 'Snow Treaders',
  icon: 'Snow Treaders',
  setType: 'Mythic',
  bonuses: [
...
export const spaulderOfRuin: GearSetData = {
...
export const stormweaversCavort: GearSetData = {
...
export const syrabanesWard: GearSetData = {
  name: "Syrabane's Ward",
  icon: "Syrabane's Ward",
  setType: 'Mythic',
  bonuses: [
...
export const theSaintAndTheSeducer: GearSetData = {
...
export const theShadowQueensCowl: GearSetData = {
...
export const thrassianStranglers: GearSetData = {
...
export const torcOfTonalConstancy: GearSetData = {
  name: 'Torc of Tonal Constancy',
  icon: 'Torc of Tonal Constancy',
  setType: 'Mythic',
  bonuses: [
...
export const torcOfTheLastAyleidKing: GearSetData = {
...
export const velothiUrMagesAmulet: GearSetData = {
