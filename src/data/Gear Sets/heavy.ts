...
export const abyssalBrace: GearSetData = {
  name: 'Abyssal Brace',
  icon: 'Abyssal Brace',
  setType: 'Dungeon',
  bonuses: [
    ...
    '(5 items) Adds 1710 Maximum Health',
...
export const adamantLurker: GearSetData = {
  name: 'Adamant Lurker',
  icon: 'Adamant Lurker',
  setType: 'Overland',
  bonuses: [
    ...
    '(5 items) Gain 1505 Health Recovery while you are standing still.',
  ],
};
...
export const aegisOfGalenwe: GearSetData = {
  name: 'Aegis of Galenwe',
  icon: 'Aegis of Galenwe',
  setType: 'Trial',
  bonuses: [
...
export const affliction: GearSetData = {
  name: 'Affliction',
  icon: 'Affliction',
  setType: 'PvP',
  bonuses: [
    ...
    '(5 items) When you deal damage, you deal 2045 Disease Damage to the target. The enemy is then afflicted with the Diseased status effect, applying Minor Defile to the target, reducing their Healing Received and damage shield strength by 6% for 4 seconds. This effect can occur once every 4 seconds and scales off the higher of your Weapon or Spell Damage.',
  ],
};

export const akaviriDragonguard: GearSetData = {
  name: 'Akaviri Dragonguard',
  icon: 'Akaviri Dragonguard',
  setType: 'Overland',
  bonuses: [
    '(2 items) Adds 129 Magicka Recovery',
    '(3 items) Adds 4% Healing Taken',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) Adds 158 Health Recovery',
...
export const arkasissGenius: GearSetData = {
  name: "Arkasis's Genius",
  icon: "Arkasis's Genius",
  setType: 'Dungeon',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1487 Armor',
...
export const armorOfTruth: GearSetData = {
  name: 'Armor of Truth',
  icon: 'Armor of Truth',
  setType: 'Dungeon',
  bonuses: [
    ...
    '(3 items) Adds 1096 Maximum Stamina',
    '(4 items) Adds 129 Weapon and Spell Damage',
    '(5 items) When you deal damage to an enemy who is Off Balance, your Weapon and Spell Damage are increased by 460 for 10 seconds.',
  ],
};
...
export const armorOfTheVeiledHeritance: GearSetData = {
  name: 'Armor of the Veiled Heritance',
  icon: 'Armor of the Veiled Heritance',
  setType: 'Overland',
  bonuses: [
    '(2 items) Adds 129 Weapon and Spell Damage',
    '(3 items) Adds 1487 Armor',
    '(4 items) Adds 1487 Armor',
    '(5 items) When you interrupt an enemy, you gain 516 Weapon and Spell Damage for 15 seconds. Your Bash attacks deal 516 more damage.',
  ],
};
...
export const aspectOfMazzatun: GearSetData = {
  name: 'Aspect of Mazzatun',
  icon: 'Aspect of Mazzatun',
  setType: 'Dungeon',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1096 Maximum Stamina',
    '(4 items) Adds 1096 Maximum Magicka',
    '(5 items) When you take damage while under 30% Health, you heal for 10691 Health and restore 10481 Magicka and Stamina. This effect can occur once every 45 seconds.',
  ],
};
...
export const automatedDefense: GearSetData = {
  name: 'Automated Defense',
  icon: 'Automated Defense',
  setType: 'Trial',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Gain Minor Aegis at all times, reducing your damage taken from Dungeon, Trial, and Arena Monsters by 5%.',
...
export const ayleidRefuge: GearSetData = {
  name: 'Ayleid Refuge',
  icon: 'Ayleid Refuge',
  setType: 'Overland',
  bonuses: [
...
export const baanDarsBlessing: GearSetData = {
  name: "Baan Dar's Blessing",
  icon: "Baan Dar's Blessing",
  setType: 'PvP',
  bonuses: [
    '(2 items) Adds 1487 Armor',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) Reduce the duration of Breakable Crowd Control, Immobilizes, and Snares on you by 75%.\n\nReduce the duration of your Breakable Crowd Control, Immobilizes, and Snares by 38%.',
  ],
};
...
export const banisTorment: GearSetData = {
  name: "Bani's Torment",
  icon: "Bani's Torment",
  setType: 'Dungeon',
  bonuses: [
...
export const bastionOfTheDraoife: GearSetData = {
  name: 'Bastion of the Draoife',
  icon: 'Bastion of the Draoife',
  setType: 'Overland',
  bonuses: [
    '(2 items) Adds 1096 Maximum Stamina',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1096 Maximum Stamina',
    '(5 items) Blocking an attack grants you a stack of Inflection for 10 seconds, up to 3 stacks max. You can gain up to 1 stack every 0.5 seconds. Increase your Magicka and Stamina Recovery by 106 per stack of Inflection.',
  ],
};

export const bastionOfTheHeartland: GearSetData = {
  name: 'Bastion of the Heartland',
  icon: 'Bastion of the Heartland',
  setType: 'PvP',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 4% Healing Taken',
    '(4 items) Reduces your damage taken from Players by 3%.',
    '(5 items) Reduces your damage taken from Siege Weapons and Player area of effect abilities by 10%.',
  ],
};

export const battalionDefender: GearSetData = {
  name: 'Battalion Defender',
  icon: 'Battalion Defender',
  setType: 'PvP',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1096 Maximum Stamina',
    '(4 items) Adds 4% Healing Done',
    '(5 items) When you Block, heal yourself or a group member within 15 meters of you for 1052 Health. This effect can occur every 1 second and scales off your Max Health.',
  ],
};
...
export const beckoningSteel: GearSetData = {
  name: 'Beckoning Steel',
  icon: 'Beckoning Steel',
  setType: 'PvP',
  bonuses: [
    '(2 items) Adds 1487 Armor',
    '(3 items) Adds 1206 Maximum Health',
...
export const beekeepersGear: GearSetData = {
  name: "Beekeeper's Gear",
  icon: "Beekeeper's Gear",
  setType: 'Overland',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) Adds 900 Health Recovery',
  ],
};

export const berserkingWarrior: GearSetData = {
...
export const blackFoundrySteel: GearSetData = {
  name: 'Black Foundry Steel',
  icon: 'Black Foundry Steel',
  setType: 'Dungeon',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1096 Maximum Stamina',
    '(4 items) Adds 1096 Maximum Stamina',
    '(5 items) Automatically block all attacks at no cost for 2 seconds when you begin a Heavy Attack. This effect can occur once every 12 seconds.',
  ],
};
...
export const blackRose: GearSetData = {
  name: 'Black Rose',
  icon: 'Black Rose',
  setType: 'PvP',
  bonuses: [
...
export const blackfeatherFlight: GearSetData = {
  name: 'Blackfeather Flight',
  icon: 'Blackfeather Flight',
  setType: 'PvP',
  bonuses: [
    '(2 items) Adds 4% Healing Taken',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1487 Armor',
    '(5 items) When you Break Free, gain 100% Movement Speed for 7 seconds. This effect can occur once every 28 seconds.',
  ],
};
...
export const bogRaider: GearSetData = {
  name: 'Bog Raider',
  icon: 'Bog Raider',
  setType: 'Overland',
  bonuses: [
    ...
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1096 Maximum Stamina',
    '(5 items) When an enemy you have recently damaged dies, gain 10 Ultimate and increase your Health Recovery by 1156 for 10 seconds. This effect can occur once every 10 seconds.',
  ],
};

export const brandsOfImperium: GearSetData = {
  name: 'Brands of Imperium',
  icon: 'Brands of Imperium',
  setType: 'Dungeon',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1206 Maximum Health',
...
export const callOfTheUndertaker: GearSetData = {
  name: 'Call of the Undertaker',
  icon: 'Call of the Undertaker',
  setType: 'Overland',
  bonuses: [
    '(2 items) Adds 4% Healing Taken',
    '(3 items) Adds 1206 Maximum Health',
    ...
    '(5 items) When you deal damage, you apply Minor Lifesteal to your enemy for 8 seconds, healing you and your allies for 612 Health every 1 second when damaging them.',
  ],
};

export const championOfTheHist: GearSetData = {
  name: 'Champion of the Hist',
  icon: 'Champion of the Hist',
  setType: 'Overland',
  bonuses: [
    '(2 items) Adds 129 Weapon and Spell Damage',
    '(3 items) Adds 1096 Maximum Stamina',
    '(4 items) Adds 1096 Maximum Stamina',
    '(5 items) Adds 1600 Maximum Health',
...
export const clawOfYolnahkriin: GearSetData = {
  name: 'Claw of Yolnahkriin',
  icon: 'Claw of Yolnahkriin',
  setType: 'Trial',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Gain Minor Aegis at all times, reducing your damage taken from Dungeon, Trial, and Arena Monsters by 5%.',
...
export const crestOfCyrodiil: GearSetData = {
  name: 'Crest of Cyrodiil',
  icon: 'Crest of Cyrodiil',
  setType: 'Dungeon',
  bonuses: [
    '(2 items) Adds 424 Critical Resistance',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) When you Block, heal for 3367 Health. This effect can occur every 4 seconds and scales off your Max Health.',
  ],
};

export const crimsonOathSRive: GearSetData = {
  name: "Crimson Oath's Rive",
  icon: "Crimson Oath's Rive",
  setType: 'Dungeon',
  bonuses: [
    '(2 items) Adds 1487 Armor',
    '(3 items) Adds 1206 Maximum Health',
...
export const crimsonTwilight: GearSetData = {
  name: 'Crimson Twilight',
  icon: 'Crimson Twilight',
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 4% Healing Taken',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) After taking damage you surround yourself in an 8 meter mist of blood. After 2 seconds, the mist is violently siphoned into your body, dealing 2372 Bleed Damage to nearby enemies and healing you for 100% of the damage done. This effect can occur once every 8 seconds and scales off your Max Health.',
  ],
};
...
export const curseOfDoylemish: GearSetData = {
  name: 'Curse of Doylemish',
  icon: 'Curse of Doylemish',
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 129 Weapon and Spell Damage',
    '(5 items) When using a fully-charged melee Heavy Attack on a taunted monster or any enemy who is stunned, feared, or immobilized, you will deal 11234 Physical Damage. This effect can occur once every 4 seconds and scales off the higher of your Weapon or Spell Damage.',
  ],
};
...
export const deeprootZeal: GearSetData = {
  name: 'Deeproot Zeal',
  icon: 'Deeproot Zeal',
  setType: 'Trial',
  bonuses: [
...
export const defendingWarrior: GearSetData = {
  name: 'Defending Warrior',
  icon: 'Defending Warrior',
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1487 Armor',
    '(3 items) Adds 1487 Armor',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) When you Block, you deal 1457 Magic Damage to all enemies within 10 meters of you and heal for 102% of the damage done. This effect can occur once every 5 seconds and scales off your Max Health.',
  ],
};
...
export const dolorousArena: GearSetData = {
  name: 'Dolorous Arena',
  icon: 'Dolorous Arena',
  setType: 'Monster Set',
  bonuses: [
...
export const dragonSDefilement: GearSetData = {
  ...
  bonuses: [
    ...
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) Adds 1206 Maximum Health',
    '(5 items) When you take damage from a melee attack, gain a corrupting aura for 5 seconds that applies Minor Breach to all enemies within 8 meters of you, reducing their Physical and Spell Resistance by 2974. This effect can occur every 5 seconds.',
  ],
};

export const drakeSRush: GearSetData = {
  name: "Drake's Rush",
  icon: "Drake's Rush",
  setType: 'Overland',
  bonuses: [
    ...
    '(3 items) Adds 1096 Maximum Stamina',
    '(4 items) Adds 1096 Maximum Stamina',
    '(5 items) When you Bash an enemy, you and up to 3 group members within 15 meters of you gain Major Heroism for 12 seconds, granting you 3 Ultimate every 1.5 seconds. This effect can occur once every 18 seconds.',
  ],
};

export const draugrSHeritage: GearSetData = {
  name: "Draugr's Heritage",
  icon: "Draugr's Heritage",
  setType: 'Dungeon',
  bonuses: [
    '(2 items) Adds 4% Healing Taken',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) When you take damage while you are under 35% Health, you knockdown all enemies within 4 meters of you for 2 seconds and heal for 5061 Health. This effect can occur once every 7 seconds and the heal scales off the higher of your Max Magicka or Stamina.',
  ],
};

export const dreughKingSlayer: GearSetData = {
  name: 'Dreugh King Slayer',
  icon: 'Dreugh King Slayer',
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 129 Weapon and Spell Damage',
    '(3 items) Adds 129 Weapon and Spell Damage',
    '(4 items) Adds 657 Critical Chance',
    '(5 items) Gain Major Brutality and Sorcery at all times, increasing your Weapon and Spell Damage by 20%. When you kill an enemy, you gain Major Expedition for 8 seconds, increasing your Movement Speed by 30%.',
  ],
};
...
export const duneripperSScales: GearSetData = {
  name: "Duneripper's Scales",
  icon: "Duneripper's Scales",
  setType: 'Dungeon',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 4% Healing Taken',
    '(4 items) Adds 4% Healing Taken',
    '(5 items) While you are Bracing, your Physical and Spell Resistance are increased by 5310.',
  ],
};

export const durokSBane: GearSetData = {
  name: "Durok's Bane",
  icon: "Durok's Bane",
  setType: 'Monster Set',
  bonuses: [
    ...
    '(4 items) Adds 4% Healing Taken',
    '(5 items) When you take damage, you apply Major Defile to the enemy for 5 seconds, reducing their healing received and damage shield strength by 12%. This effect can occur once every 7 seconds per enemy.',
  ],
};
...
export const ebonArmory: GearSetData = {
  name: 'Ebon Armory',
  icon: 'Ebon Armory',
  setType: 'PvP',
  bonuses: [
    ...
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 4% Healing Taken',
    '(5 items) Increases Max Health by 1000 for you and up to 11 other group members within 28 meters of you. This bonus persists through death.',
  ],
};

export const elfBane: GearSetData = {
  name: 'Elf Bane',
  icon: 'Elf Bane',
  setType: 'Dungeon',
  bonuses: [
    ...
    '(3 items) Adds 129 Weapon and Spell Damage',
    '(4 items) Adds 129 Weapon and Spell Damage',
    '(5 items) While in combat, increases the duration of your Flame Damage over Time abilities by 5 seconds.\n\nThis effect does not work with beam or channeled effects. Applies to Dragonknight Standard.',
  ],
};

export const embershield: GearSetData = {
  name: 'Embershield',
  icon: 'Embershield',
  setType: 'Monster Set',
  bonuses: [
    ...
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1487 Armor',
    '(5 items) When you complete a fully-charged Heavy Attack, you increase your Physical and Spell Resistance by 3300 and deal 371 Flame Damage to all enemies within 5 meters of you every 1 second for 6 seconds. The damage scales off the higher of your Physical or Spell Resistance.',
  ],
};
...
export const enervatingAura: GearSetData = {
  name: 'Enervating Aura',
  icon: 'Enervating Aura',
  setType: 'Monster Set',
  bonuses: [
    '(2 items) Adds 4% Healing Taken',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1487 Armor',
    '(5 items) When you deal direct damage, you have a 10% chance to create an area under the target that detonates after 1 second, applying Enervating Aura and Minor Enervation for 10 seconds to enemies within 5 meters. Enervating Aura lowers the Health Recovery, Magicka Recovery, and Stamina Recovery of enemy players by 129 per player hit. This effect can occur once every 15 seconds.',
  ],
};
...
export const eternalVigor: GearSetData = {
  name: 'Eternal Vigor',
  icon: 'Eternal Vigor',
  setType: 'Trial',
  bonuses: [
...
export const eternalWarrior: GearSetData = {
  name: 'Eternal Warrior',
  icon: 'Eternal Warrior',
  setType: 'Monster Set',
  bonuses: [
    '(2 items) Adds 4% Healing Taken',
    '(3 items) Gain Minor Aegis at all times, reducing your damage taken from Dungeon, Trial, and Arena Monsters by 5%.',
    ...
    '(5 items) When you take damage while below 25% Health in combat, you heal for 10991 Health and gain 100 Ultimate. This effect can occur once every 1 minute and the heal scales off your Max Health.',
  ],
};
...
export const explosiveRebuke: GearSetData = {
  name: 'Explosive Rebuke',
  icon: 'Explosive Rebuke',
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1096 Maximum Stamina',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 129 Weapon and Spell Damage',
    '(5 items) When you Block, you place a bomb on the enemy for 10 seconds. When they are hit with a fully-charged Heavy Attack, the bomb detonates, dealing 3440 Flame Damage to all enemies within 8 meters and applying the Burning status effect to them. This effect can occur once every 8 seconds and scales off the higher of your Physical or Spell Resistance.',
  ],
};
...
export const fasallaSGuile: GearSetData = {
  name: "Fasalla's Guile",
  icon: "Fasalla's Guile",
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 4% Healing Taken',
    '(5 items) Adds 1487 Armor',
    '(5 items) While in combat, every 1 second you apply Minor Defile to enemies within 5 meters of you for 2 seconds, reducing their healing received and damage shield strength by 6%.',
  ],
};
...
export const foolkillerSWard: GearSetData = {
  name: "Foolkiller's Ward",
  icon: "Foolkiller's Ward",
  setType: 'Arena',
  bonuses: [
    '(2 items) Adds 1487 Armor',
    '(3 items) Adds 1487 Armor',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) Bracing while in combat places a damage shield on you and up to 3 group members within 18 meters for 2 seconds that absorbs up to 4000 direct damage. If a damage shield breaks, the wearer of the shield restores 5680 Magicka and Stamina.\n\nThis effect can occur once every 30 seconds if a damage shield broke. This effect can occur once every 10 seconds if no damage shields broke.',
  ],
};

export const footmanSFortune: GearSetData = {
  name: "Footman's Fortune",
  icon: "Footman's Fortune",
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1487 Armor',
    '(4 items) Adds 1487 Armor',
    '(5 items) Increases the amount of damage you block by 14%.',
  ],
};
...
export const frozenWatcher: GearSetData = {
  name: 'Frozen Watcher',
  icon: 'Frozen Watcher',
  setType: 'Overland',
  bonuses: [
    ...
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1096 Maximum Stamina',
    '(5 items) Summon a blizzard around you while you are Bracing, inflicting 570 Frost Damage every 1 second to enemies within 6 meters. This effect scales off your Max Health and has a 15% chance of inflicting the Chilled status effect.',
  ],
};

export const fullBellyBarricade: GearSetData = {
  name: 'Full Belly Barricade',
  icon: 'Full Belly Barricade',
  setType: 'PvP',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1096 Maximum Stamina',
    '(4 items) Adds 1096 Maximum Stamina',
    '(5 items) While you have a food buff active, your Block Mitigation is increased by 8% and block cost is reduced by 8%.',
  ],
};
...
export const glacialGuardian: GearSetData = {
  name: 'Glacial Guardian',
  icon: 'Glacial Guardian',
  setType: 'Monster Set',
  bonuses: [
    '(2 items) Adds 1487 Armor',
    '(3 items) Adds 1096 Maximum Stamina',
    '(4 items) Adds 129 Health Recovery',
    '(5 items) When you Block, tether to the enemy if they are within 8 meters of you for 8 seconds. While tethered, you deal 295 Frost Damage every second to enemies touching the tether and cause them to have a 200% increased Status Effect Chance. The tether breaks if the target moves more than 12 meters away. This effect can occur once every 12 seconds and the damage scales off your Max Health.',
  ],
};
...
export const gloriousDefender: GearSetData = {
  name: 'Glorious Defender',
  icon: 'Glorious Defender',
  setType: 'Overland',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1206 Maximum Health',
...
export const graceOfGloom: GearSetData = {
  name: 'Grace of Gloom',
  icon: 'Grace of Gloom',
  setType: 'Dungeon',
  bonuses: [
    ...
    '(3 items) Adds 4% Healing Taken',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) When you take damage, you become a living shadow for 10 seconds, causing you to heal for 1087 every 2 seconds and gaining Major Evasion, reducing damage from area attacks by 20%. This effect can occur every 20 seconds and scales off your Max Health.',
  ],
};

export const graveGuardian: GearSetData = {
  name: 'Grave Guardian',
  icon: 'Grave Guardian',
  setType: 'Craftable',
  bonuses: [
...
export const greenPact: GearSetData = {
  name: 'Green Pact',
  icon: 'Green Pact',
  setType: 'Monster Set',
  bonuses: [
    ...
    '(3 items) Adds 129 Health Recovery',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) While you have a food buff active, your Max Health is increased by 2500 and Health Recovery by 356.',
  ],
};
...
export const hagravenSGarden: GearSetData = {
  name: "Hagraven's Garden",
  icon: "Hagraven's Garden",
  setType: 'Dungeon',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 129 Health Recovery',
...
export const handOfMephala: GearSetData = {
  name: 'Hand of Mephala',
  icon: 'Hand of Mephala',
  setType: 'Overland',
  bonuses: [
    '(2 items) Adds 4% Healing Taken',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1487 Armor',
    '(5 items) When you take damage, you encase the ground beneath you in webs for 5 seconds, reducing the Movement Speed of enemies within a 4 meter radius by 33% and applying Minor Breach to them, reducing their Physical and Spell Resistance by 2974. After 5 seconds the webs burst into venom, dealing 1775 Poison Damage. This effect can occur once every 5 seconds and scales off the higher of your Physical or Spell Resistance.',
  ],
};

export const hatchlingSShell: GearSetData = {
  name: "Hatchling's Shell",
  icon: "Hatchling's Shell",
  setType: 'Dungeon',
  bonuses: [
    '(2 items) Adds 1487 Armor',
    '(3 items) Adds 1487 Armor',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) Whenever you take damage you gain a damage shield that absorbs up to 3680 damage for 6 seconds. This effect can occur once every 6 seconds and scales off your Max Health.',
  ],
};

export const havenOfUrsus: GearSetData = {
  name: 'Haven of Ursus',
  icon: 'Haven of Ursus',
  setType: 'Craftable',
  bonuses: [
...
export const heroicUnity: GearSetData = {
  name: 'Heroic Unity',
  icon: 'Heroic Unity',
  setType: 'Overland',
  bonuses: [
    ...
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) Activating a Synergy gives you and up to 3 group members within 12 meters Major Heroism for 6 seconds, granting 3 Ultimate every 1.5 seconds. This effect can occur once every 1 second.',
  ],
};

export const hideOfMorihaus: GearSetData = {
  name: 'Hide of Morihaus',
  icon: 'Hide of Morihaus',
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1487 Armor',
    ...
    '(5 items) When you Roll Dodge through an enemy, you deal 1505 Physical Damage and knock them down for 3 seconds. This effect scales off the higher of your Physical or Spell Resistance.',
  ],
};
...
export const hrothgarSChill: GearSetData = {
  name: "Hrothgar's Chill",
  icon: "Hrothgar's Chill",
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1487 Armor',
...
export const immortalWarrior: GearSetData = {
  name: 'Immortal Warrior',
  icon: 'Immortal Warrior',
  setType: 'PvP',
  bonuses: [
    '(2 items) Adds 4% Healing Taken',
    '(3 items) Adds 1206 Maximum Health',
...
export const ironblood: GearSetData = {
  name: 'Ironblood',
  icon: 'Ironblood',
  setType: 'Dungeon',
  bonuses: [
...
export const jailerSTenacity: GearSetData = {
  name: "Jailer's Tenacity",
  icon: "Jailer's Tenacity",
  setType: 'PvP',
  bonuses: [
    '(2 items) Adds 4% Healing Taken',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 4% Healing Taken',
    '(5 items) When you lose 7000 or more Health from a single attack, you gain Major Vitality for 8 seconds, increasing your healing received and damage shield strength by 12%.',
  ],
};
...
export const joltingArms: GearSetData = {
  name: 'Jolting Arms',
  icon: 'Jolting Arms',
  setType: 'PvP',
  bonuses: [
...
export const judgmentOfAkatosh: GearSetData = {
  name: 'Judgment of Akatosh',
  icon: 'Judgment of Akatosh',
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 129 Weapon and Spell Damage',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) Adds 2291 Armor',
...
export const knightErrantSMail: GearSetData = {
  name: "Knight-Errant's Mail",
  icon: "Knight-Errant's Mail",
  setType: 'Dungeon',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1096 Maximum Stamina',
    '(4 items) Adds 129 Weapon and Spell Damage',
    '(5 items) Adds 450 Weapon and Spell Damage to your One Hand and Shield abilities. When you use a One Hand and Shield ability, you heal for 1568 Health.',
  ],
};

export const knightmare: GearSetData = {
  name: 'Knightmare',
  icon: 'Knightmare',
  setType: 'Monster Set',
  bonuses: [
...
export const kynmarcherSCruelty: GearSetData = {
  name: "Kynmarcher's Cruelty",
  icon: "Kynmarcher's Cruelty",
  setType: 'Monster Set',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 129 Stamina Recovery',
    '(4 items) Adds 1487 Armor',
    '(5 items) When you deal direct damage, you apply one of 5 random Major debuffs to enemies within 8 meters of you for 18 seconds. This effect can occur once every 8 seconds and only if an enemy is in range.\n\nEligible effects are Major Breach, Major Cowardice, Major Defile, Major Maim, and Major Vulnerability.',
  ],
};
...
export const leechingPlate: GearSetData = {
  name: 'Leeching Plate',
  icon: 'Leeching Plate',
  setType: 'Craftable',
  bonuses: [
    ...
    '(3 items) Adds 4% Healing Taken',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) When you take damage, you summon a cloud of leeching poison under the assailant. The cloud deals 491 Poison Damage every 1 second for 5 seconds and heals you for 102% of the damage caused. This effect can occur once every 5 seconds and scales off your Max Health.',
  ],
};
...
export const livewire: GearSetData = {
  name: 'Livewire',
  icon: 'Livewire',
  setType: 'Monster Set',
  bonuses: [
    ...
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 4% Healing Taken',
    '(5 items) When you take damage, you overload your circuits, applying Concussion to enemies within 8 meters of you and healing for 1020 Health for each enemy hit. This effect can occur once every 6 seconds.',
  ],
};
...
export const lucentEchoes: GearSetData = {
  name: 'Lucent Echoes',
  icon: 'Lucent Echoes',
  setType: 'Dungeon',
  bonuses: [
...
export const lucillaSWindshield: GearSetData = {
  name: "Lucilla's Windshield",
  icon: "Lucilla's Windshield",
  setType: 'Trial',
  bonuses: [
    '(2 items) Adds 4% Healing Taken',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1096 Maximum Stamina',
    '(5 items) Blocking 3 attacks within 10 seconds creates an 8 meter Windshield at your feet for 10 seconds. Enemies within the area gain Minor Brittle, increasing their Critical Damage taken by 10%. While you are within the area, you gain Major Protection, reducing your damage taken by 10%. This effect can occur once every 7 seconds. You can only have 1 Windshield active at a time.',
  ],
};

export const lunarBastion: GearSetData = {
  name: 'Lunar Bastion',
  icon: 'Lunar Bastion',
  setType: 'Monster Set',
  bonuses: [
...
export const maraSBalm: GearSetData = {
  name: "Mara's Balm",
  icon: "Mara's Balm",
  setType: 'Overland',
  bonuses: [
...
export const medusa: GearSetData = {
  name: 'Medusa',
  icon: 'Medusa',
  setType: 'Overland',
  bonuses: [
    ...
    '(3 items) Adds 657 Critical Chance',
    '(4 items) Adds 657 Critical Chance',
    '(5 items) Adds 892 Critical Chance',
    '(5 items) Gain Minor Force at all times, increasing your Critical Damage by 10%.',
  ],
};

export const meridiaSBlessedArmor: GearSetData = {
  name: "Meridia's Blessed Armor",
  icon: "Meridia's Blessed Armor",
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1487 Armor',
    '(3 items) Adds 129 Stamina Recovery',
...
export const mightyGlacier: GearSetData = {
  name: 'Mighty Glacier',
  icon: 'Mighty Glacier',
  setType: 'Monster Set',
  bonuses: [
...
export const netchOil: GearSetData = {
  name: 'Netch Oil',
  icon: 'Netch Oil',
  setType: 'Craftable',
  bonuses: [
    ...
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1096 Maximum Stamina',
    '(5 items) While you have Crowd Control Immunity, you are immune to Snares and Immobilizations.',
  ],
};
...
export const nightMotherSEmbrace: GearSetData = {
  name: "Night Mother's Embrace",
  icon: "Night Mother's Embrace",
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1096 Maximum Stamina',
    '(3 items) Adds 129 Weapon and Spell Damage',
...
export const nikulasHeavyArmor: GearSetData = {
  name: "Nikulas' Heavy Armor",
  icon: "Nikulas' Heavy Armor",
  setType: 'Class Sets',
  bonuses: [
    '(2 items) Adds 1487 Armor',
    '(3 items) Adds 1487 Armor',
    '(4 items) Adds 1206 Maximum Health',
    "(5 items) When you Block, you gain a stack of Nikulas' Resolve for 5 seconds, up to once every half second. After 8 stacks you consume Nikulas' Resolve and deflect the next direct damaging attack made against you within 5 seconds, avoiding it completely.",
  ],
};
...
export const orderOfDiagna: GearSetData = {
  name: 'Order of Diagna',
  icon: 'Order of Diagna',
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 4% Healing Taken',
    '(5 items) Adds 5% Healing Taken',
...
export const pangritDenmother: GearSetData = {
  name: 'Pangrit Denmother',
  icon: 'Pangrit Denmother',
  setType: 'Trial',
  bonuses: [
    '(2 items) Adds 4% Healing Taken',
    '(3 items) Adds 1487 Armor',
    '(4 items) Adds 129 Health Recovery',
    '(5 items) Adds 1890 Maximum Stamina',
...
export const pearlescentWard: GearSetData = {
  name: 'Pearlescent Ward',
  icon: 'Pearlescent Ward',
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Gain Minor Aegis at all times, reducing your damage taken from Dungeon, Trial, and Arena Monsters by 5%.',
...
export const perfectedAegisOfGalenwe: GearSetData = {
...
export const perfectedClawOfYolnahkriin: GearSetData = {
...
export const perfectedDolorousArena: GearSetData = {
...
export const perfectedLucentEchoes: GearSetData = {
...
export const perfectedPearlescentWard: GearSetData = {
...
export const perfectedSaxhleelChampion: GearSetData = {
...
export const perfectedTestOfResolve: GearSetData = {
...
export const perfectedVrolSCommand: GearSetData = {
...
export const permafrost: GearSetData = {
  name: 'Permafrost',
  icon: 'Permafrost',
  setType: 'Monster Set',
  bonuses: [
    ...
    '(3 items) Adds 1096 Maximum Magicka',
    '(4 items) Adds 129 Magicka Recovery',
    '(5 items) While you have a damage shield on you, your Health Recovery is increased by 1106.',
  ],
};
...
export const plagueDoctor: GearSetData = {
  name: 'Plague Doctor',
  icon: 'Plague Doctor',
  setType: 'Monster Set',
  bonuses: [
    ...
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) Adds 2804 Maximum Health',
  ],
};
...
export const radiantBastion: GearSetData = {
  name: 'Radiant Bastion',
  icon: 'Radiant Bastion',
  setType: 'Dungeon',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 129 Weapon and Spell Damage',
...
export const rattlecage: GearSetData = {
  name: 'Rattlecage',
  icon: 'Rattlecage',
  setType: 'PvP',
  bonuses: [
...
export const ravager: GearSetData = {
  name: 'Ravager',
  icon: 'Ravager',
  setType: 'PvP',
  bonuses: [
    ...
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 129 Weapon and Spell Damage',
    "(5 items) Each time you attempt to reduce the target's Physical or Spell Resistance, you gain a stack of Ravager for 5 seconds, increasing your Weapon and Spell Damage by 146. You can gain a stack every 1 second. At 4 stacks, the duration doubles but cannot be refreshed.",
  ],
};

export const reactiveArmor: GearSetData = {
  name: 'Reactive Armor',
  icon: 'Reactive Armor',
  setType: 'Class Sets',
  bonuses: [
    ...
    '(3 items) Adds 129 Stamina Recovery',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) After you are affected by a disabling effect, your damage taken is reduced by 33% for 5 seconds. This effect can occur every 20 seconds.',
  ],
};
...
export const reflectedFury: GearSetData = {
  name: 'Reflected Fury',
  icon: 'Reflected Fury',
  setType: 'Dungeon',
  bonuses: [
    ...
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1096 Maximum Stamina',
    '(5 items) When you taunt an enemy, gain a stack of Broken Shards for 5 seconds, up to 5 stacks max. You can only gain one stack every 1 second. When Broken Shards ends, you release the stacks in an 8 meter blast, dealing 1121 Physical Damage to enemies hit and applying Major Maim to them for 3 seconds per stack of Broken Shards consumed, reducing their damage done by 10%. The damage scales off your Max Health.',
  ],
};

export const renaldSResolve: GearSetData = {
  name: "Renald's Resolve",
  icon: "Renald's Resolve",
  setType: 'Monster Set',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 4% Healing Taken',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) Whenever you deal direct damage, gain a stack of Resolve for 5 seconds. Each stack increases your healing received by 1% and your Physical and Spell Resistance by 420.\n\nThis effect can occur once every half second and can stack up to 9 times.',
  ],
};
...
export const saxhleelChampion: GearSetData = {
  name: 'Saxhleel Champion',
  icon: 'Saxhleel Champion',
  setType: 'Monster Set',
  bonuses: [
    '(2 items) Adds 1096 Maximum Magicka',
    '(3 items) Gain Minor Aegis at all times, reducing your damage taken from Dungeon, Trial, and Arena Monsters by 5%.',
...
export const senchalDefender: GearSetData = {
  name: 'Senchal Defender',
  icon: 'Senchal Defender',
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1096 Maximum Stamina',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1096 Maximum Magicka',
    "(5 items) Dealing direct damage with a non-Heavy Attack grants you one persistent stack of Senchal's Duty, up to 10 stacks. After completing a fully-charged Heavy Attack, restore 757 Stamina and Magicka for each stack of Senchal's Duty and consume them. You can only gain one stack of Senchal's Duty every 1 second.",
  ],
};
...
export const sergeantSMail: GearSetData = {
  name: "Sergeant's Mail",
  icon: "Sergeant's Mail",
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 129 Health Recovery',
...
export const seventhLegionBrute: GearSetData = {
  name: 'Seventh Legion Brute',
  icon: 'Seventh Legion Brute',
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 129 Weapon and Spell Damage',
    '(3 items) Adds 129 Health Recovery',
    '(4 items) Adds 657 Critical Chance',
    '(5 items) When you cast an ability that grants Major or Minor Resolve while in combat, you gain 341 Weapon and Spell Damage and 341 Health Recovery for 15 seconds. This effect can occur every 15 seconds.',
  ],
};
...
export const shalkExoskeleton: GearSetData = {
  name: 'Shalk Exoskeleton',
  icon: 'Shalk Exoskeleton',
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 129 Weapon and Spell Damage',
...
export const siegemasterSFocus: GearSetData = {
  name: "Siegemaster's Focus",
  icon: "Siegemaster's Focus",
  setType: 'Dungeon',
  bonuses: [
    '(2 items) Adds 424 Critical Resistance',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1487 Armor',
    '(5 items) While you are using a non-Ram Siege Weapon you are immune to knockback and disabling effects, you reduce your damage taken by 33%, and you can see enemies through walls.',
  ],
};

export const silverRoseVigil: GearSetData = {
  name: 'Silver Rose Vigil',
  icon: 'Silver Rose Vigil',
  setType: 'Overland',
  bonuses: [
    '(2 items) Adds 1096 Maximum Stamina',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1096 Maximum Stamina',
    '(5 items) When you Block, gain a stack of Realmshaper for 15 seconds, gaining up to 1 stack every 0.5 seconds. When you reach 3 stacks, you consume them and launch necrotic energy at your attacker, dealing 4155 Magic Damage and applying Major Maim for 12 seconds, reducing their damage done by 10%. Once you fire the necrotic energy, you cannot gain additional stacks of Realmshaper for 12 seconds. Damage scales off your Max Health.',
  ],
};
...
export const soulshine: GearSetData = {
  name: 'Soulshine',
  icon: 'Soulshine',
  setType: 'Class Sets',
  bonuses: [
    ...
    '(3 items) Adds 657 Critical Chance',
    '(4 items) Adds 129 Weapon and Spell Damage',
    '(5 items) Activating an ability with a cast or channel time grants you 369 Weapon and Spell Damage for 5 seconds.',
  ],
};
...
export const steadfastHero: GearSetData = {
  name: 'Steadfast Hero',
  icon: 'Steadfast Hero',
  setType: 'Overland',
  bonuses: [
    ...
    '(3 items) Adds 1487 Armor',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) When you cleanse a negative effect from yourself or an ally, gain Major Protection for 10 seconds, reducing your damage taken by 10%. This effect can occur once every 12 seconds.',
  ],
};
...
export const stonehulkDomination: GearSetData = {
  name: 'Stonehulk Domination',
  icon: 'Stonehulk Domination',
  setType: 'Monster Set',
  bonuses: [
    '(2 items) Adds 4% Healing Taken',
    '(3 items) Adds 1096 Maximum Stamina',
    '(4 items) Adds 1096 Maximum Stamina',
    '(5 items) When you taunt an enemy, apply Major Vulnerability to them, increasing their damage taken by 10% for 12 seconds. This effect can occur once every 15 seconds.',
  ],
};
...
export const stormKnightSPlate: GearSetData = {
  name: "Storm Knight's Plate",
  icon: "Storm Knight's Plate",
  setType: 'Monster Set',
  bonuses: [
    '(2 items) Adds 1487 Armor',
    '(3 items) Adds 1487 Armor',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) When you take non-Physical Damage, you deal 1977 Shock Damage to all enemies within 5 meters of you every 2 seconds for 6 seconds. This effect can occur once every 6 seconds and scales off the higher of your Weapon or Spell Damage.',
  ],
};
...
export const systresScowl: GearSetData = {
  name: "Systres' Scowl",
  icon: "Systres' Scowl",
  setType: 'Overland',
  bonuses: [
    ...
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1096 Maximum Stamina',
    "(5 items) When you Bash an enemy, place Systres' Scowl on them for 15 seconds. When hit by a Light Attack, a target with Systres' Scowl takes 2210 Frost Damage, up to once every second.",
  ],
};
...
export const telvanniEnforcer: GearSetData = {
  name: 'Telvanni Enforcer',
  icon: 'Telvanni Enforcer',
  setType: 'Trial',
  bonuses: [
    '(2 items) Adds 1096 Maximum Stamina',
    '(3 items) Adds 1206 Maximum Health',
...
export const testOfResolve: GearSetData = {
  name: 'Test of Resolve',
  icon: 'Test of Resolve',
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1487 Armor',
    '(3 items) Gain Minor Aegis at all times, reducing your damage taken from Dungeon, Trial, and Arena Monsters by 5%.',
...
export const theIceFurnace: GearSetData = {
  name: 'The Ice Furnace',
  icon: 'The Ice Furnace',
  setType: 'PvP',
  bonuses: [
    '(2 items) Adds 1096 Maximum Magicka',
    '(3 items) Adds 657 Critical Chance',
    '(4 items) Adds 129 Weapon and Spell Damage',
    '(5 items) When you deal Frost Damage, you deal an additional 1397 Flame Damage to all enemies within 8 meters around the initial target. This effect can occur once every 1 second and scales off the higher of your Weapon or Spell Damage.',
  ],
};

export const theJuggernaut: GearSetData = {
  name: 'The Juggernaut',
  icon: 'The Juggernaut',
  setType: 'Monster Set',
  bonuses: [
    ...
    '(3 items) Adds 1487 Armor',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) When you take damage while under 30% Health, heal for 5194 Health immediately and gain 20000 Armor for 15 seconds. This effect can occur once every 1 minute and the heal scales off your Max Health.',
  ],
};
...
export const thunderbugSCarapace: GearSetData = {
  name: "Thunderbug's Carapace",
  icon: "Thunderbug's Carapace",
  setType: 'Monster Set',
  bonuses: [
    '(2 items) Adds 1487 Armor',
    '(3 items) Adds 1487 Armor',
    '(4 items) Adds 129 Weapon and Spell Damage',
    '(5 items) When you take Physical Damage, you deal 4191 Shock Damage in a 5 meter radius around you. This effect can occur once every 3 seconds and scales off the higher of your Weapon or Spell Damage.',
  ],
};
...
export const tormentor: GearSetData = {
  name: 'Tormentor',
  icon: 'Tormentor',
  setType: 'Craftable',
  bonuses: [
    ...
    '(3 items) Adds 4% Healing Taken',
    '(4 items) Adds 4% Healing Taken',
    '(5 items) When you deal direct damage with a Blink, Charge, Leap, Teleport, or Pull ability, you gain 3642 Physical and Spell Resistance, taunt the first enemy hit to attack you for 15 seconds, and heal for 46% of the damage done.',
  ],
};
...
export const turningTide: GearSetData = {
  ...
  bonuses: [
    ...
    '(3 items) Adds 1096 Maximum Stamina',
    '(4 items) Adds 1206 Maximum Health',
    '(5 items) When you Block, you gain Flowing Water for 10 seconds, causing your next Bash attack to deal 2710 Magic Damage to up to 6 enemies in a 5 by 10 meter line, and apply Major Vulnerability for 10 seconds, increasing their damage taken by 10%. This effect can occur once every 15 seconds and scales off your Max Health.',
  ],
};
...
export const ulfnorSFavor: GearSetData = {
  name: "Ulfnor's Favor",
  icon: "Ulfnor's Favor",
  setType: 'Class Sets',
  bonuses: [
...
export const unflinchingUltimate: GearSetData = {
  name: 'Unflinching Ultimate',
  icon: 'Unflinching Ultimate',
  setType: 'Monster Set',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 1487 Armor',
    '(5 items) Gain 1 second of immunity to crowd control effects after casting an Ultimate for each 20 Ultimate spent.',
  ],
};
...
export const vampireCloak: GearSetData = {
  name: 'Vampire Cloak',
  icon: 'Vampire Cloak',
  setType: 'Craftable',
  bonuses: [
...
export const vanguardSChallenge: GearSetData = {
  name: "Vanguard's Challenge",
  icon: "Vanguard's Challenge",
  setType: 'Craftable',
  bonuses: [
    '(2 items) Adds 1206 Maximum Health',
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 4% Healing Taken',
    '(5 items) When you taunt an enemy player, they deal 35% less damage to all other players but 35% more damage to you for 15 seconds. This effect is lost if you enter Sneak, invisibility, or move further than 28 meters away from them.',
  ],
};
...
export const vrolSCommand: GearSetData = {
  name: "Vrol's Command",
  icon: "Vrol's Command",
  setType: 'Monster Set',
  bonuses: [
...
export const warriorSFury: GearSetData = {
  name: "Warrior's Fury",
  icon: "Warrior's Fury",
  setType: 'Overland',
  bonuses: [
...
export const warriorPoet: GearSetData = {
  name: 'Warrior-Poet',
  icon: 'Warrior-Poet',
  setType: 'Overland',
  bonuses: [
...
export const wayOfFire: GearSetData = {
  name: 'Way of Fire',
  icon: 'Way of Fire',
  setType: 'Craftable',
  bonuses: [
    ...
    '(3 items) Adds 1206 Maximum Health',
    '(4 items) Adds 657 Critical Chance',
    '(5 items) When you deal damage with a Light or Heavy Attack, you deal an additional 3543 Flame Damage. This effect can occur once every 2 seconds and scales off the higher of your Weapon or Spell Damage.',
  ],
};
...
export const wyrdTreeSBlessing: GearSetData = {
  name: "Wyrd Tree's Blessing",
  icon: "Wyrd Tree's Blessing",
  setType: 'Monster Set',
  bonuses: [
    '(2 items) Adds 129 Magicka Recovery',
    '(3 items) Adds 129 Weapon and Spell Damage',
