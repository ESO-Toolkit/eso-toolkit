...
export const AuthProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const accessTokenHasReportScopes = React.useMemo(() => tokenHasReportViewScopes(accessToken), [accessToken]);
  ...
  const isLoggedIn = !!accessToken && (accessTokenHasUser || accessTokenHasReportScopes) && !accessTokenExpired && !isBanned;
