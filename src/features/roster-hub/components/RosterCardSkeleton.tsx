...
export const RosterCardSkeleton: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Glowing accent bar — matches RosterCard feathered gradient */}
      <Box
        sx={{
          position: 'absolute',
          top: 0,
      ...
      {/* Content area — mirrors CardActionArea > CardContent in RosterCard */}
      ...
      {/* Action row — mirrors CardActions in RosterCard */}
      <CardActions
        sx={{
          px: 2.5,
          py: 1,
      ...
      >
        {/* Vote button — pill shape matches VoteButton borderRadius: '999px' */}
        <Skeleton
          variant="rounded"
          width={62}
          height={32}
        ...
        />
        {/* Right action buttons — flex container matches RosterCard layout */}
