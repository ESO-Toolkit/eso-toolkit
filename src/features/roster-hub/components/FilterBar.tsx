  ...
  ({ filters, totalCount, onFilterChange }) => {
    ...
    return (
      ...
      >
        ...
        {/* Mobile: search full-width on top, trial+sort share a row below.  */}
        {/* sm+: all three inline in one row.                                */}
        <Box
          sx={{
            display: 'flex',
        ...
        >
          ...
          {/* Trial + Sort — inline on sm+, shared flex row on xs */}
