/**
 * Shared glass-morphism style helpers for build editor pickers.
 *
 * Used by FoodPicker, PotionPicker, and any future consumable/item pickers
 * that follow the same "add" button + empty-state pattern.
 */

/** Pill-shaped outlined "Add" button with accent border + blur. */
