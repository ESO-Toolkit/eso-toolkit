    ...
    <Box>
      ...
      {damageRows.length > 0 ? (
        <Box sx={{ 
          ...
          boxShadow: '0 8px 32px 0 rgba(0, 0, 0, 0.37), inset 0 1px 0 rgba(255, 255, 255, 0.2), inset 0 -1px 0 rgba(0, 0, 0, 0.2)',
            ...
            return (
              <Box 
                ...
                sx={{ 
                  ...
                  p: 1.5,
                  backgroundColor: 'transparent',
                  borderBottom: index < damageRows.length - 1 ? '1px solid rgba(255, 255, 255, 0.05)' : 'none',
                  alignItems: 'center',
                  position: 'relative',
                  zIndex: 1,
              ...
              >
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, minWidth: 0 }}>
                  <Typography sx={{ color: '#ecf0f1', fontWeight: 500, fontSize: '0.875rem', minWidth: '60px', textShadow: '0 1px 3px rgba(0,0,0,0.5)' }}>
                    {percentage}%
                  </Typography>
                  ...
                  <Typography sx={{ color: '#ecf0f1', fontSize: '0.875rem', minWidth: '60px', textAlign: 'right', textShadow: '0 1px 3px rgba(0,0,0,0.5)' }}>
