import { RED_CHAMPION_POINTS, BLUE_CHAMPION_POINTS, GREEN_CHAMPION_POINTS, KnownAbilities } from '../../../types/abilities';
...
describe('Champion Points Constants', () => {
  it('should have the correct champion point ability IDs', () => {
    ...
    expect(BLUE_CHAMPION_POINTS.has(KnownAbilities.BULKWARK)).toBe(true);
