                ...
                >
                  ...
                  <AccordionDetails sx={{ px: 2, pb: 1.5, pt: 0.5 }}>
                    {(() => {
                          ...
                          issues.push(
                            ...
                            >
                              {(() => {
                                ...
                                const isProphecy = buff.buffName.toLowerCase().includes('prophecy');
                                const isBrutality = buff.buffName
                                  .toLowerCase()
                                  .includes('brutality');
                                const isSavagery = buff.buffName.toLowerCase().includes('savagery');
                                ...
                                if (isSorcery || isProphecy) {
                                  ...
                                  textColor = theme.palette.mode === 'dark' ? '#fbbf24' : '#d97706';
                                } else if (isBrutality || isSavagery) {
                                  // Red for DPS buffs (brutality/savagery)
                                  textColor = theme.palette.mode === 'dark' ? '#ef4444' : '#dc2626';
                                } else if (isAegis) {
                                  // Blue for tank buffs (aegis)
                                  textColor = theme.palette.mode === 'dark' ? '#3b82f6' : '#2563eb';
                                } else {
                                  // Default purple for other buffs
                                  textColor = theme.palette.mode === 'dark' ? '#c084fc' : '#9333ea';
                                }
                      ...
                      return <Box sx={{ display: 'flex', flexDirection: 'column' }}>{issues}</Box>;
                    })()}
                  </AccordionDetails>
                </Accordion>
              )}
