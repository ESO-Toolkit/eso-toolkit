...
const getGlossyBaseSx = (theme: Theme) => ({
  ...
  '& .MuiChip-label': {
    ...
    textShadow: theme.palette.mode === 'dark' ? '0 1px 3px rgba(0,0,0,0.5)' : '0 1px 2px rgba(255,255,255,0.8)',
...
const buildVariantSx = (variant: string, theme: Theme): SxProps<Theme> => {
  ...
  const darkVariants: Record<string, SxProps<Theme>> = {
    ...
    championRed: {
      background: 'linear-gradient(135deg, rgba(255, 68, 68, 0.25) 0%, rgba(255, 68, 68, 0.15) 50%, rgba(255, 68, 68, 0.08) 100%)',
      borderColor: 'rgba(255, 68, 68, 0.3)',
      '& .MuiChip-label': { color: '#ff6666' },
    },
    championBlue: {
      background: 'linear-gradient(135deg, rgba(68, 136, 255, 0.25) 0%, rgba(68, 136, 255, 0.15) 50%, rgba(68, 136, 255, 0.08) 100%)',
      borderColor: 'rgba(68, 136, 255, 0.3)',
      '& .MuiChip-label': { color: '#66aaff' },
    },
    championGreen: {
      background: 'linear-gradient(135deg, rgba(68, 255, 136, 0.25) 0%, rgba(68, 255, 136, 0.15) 50%, rgba(68, 255, 136, 0.08) 100%)',
