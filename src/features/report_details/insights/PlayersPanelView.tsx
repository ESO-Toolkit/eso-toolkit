                  ...
                  <Box display="flex" flexDirection={{ xs: 'column', md: 'row' }} alignItems="stretch" gap={2}>
                          ...
                          {(() => {
                            ...
                            return (
                              <Box display="flex" alignItems="center" gap={0.25} sx={{ mb: 0.5 }}>
                                <Typography variant="body2" fontWeight="bold">Gear Sets:</Typography>
                                <Box display="inline-flex" alignItems="center" gap={0.375} sx={{ ml: 0.25 }}>
                                  <ShieldOutlinedIcon sx={{ color: 'text.secondary', fontSize: 12 }} />
                                  <Typography variant="caption" sx={{ color: '#ff7a7a', fontSize: 11, lineHeight: 1 }}>{w.heavy}</Typography>
                                  <Typography variant="caption" sx={{ color: 'text.secondary', fontSize: 9, lineHeight: 1 }}>•</Typography>
                                  <Typography variant="caption" sx={{ color: '#93f093', fontSize: 11, lineHeight: 1 }}>{w.medium}</Typography>
                                  <Typography variant="caption" sx={{ color: 'text.secondary', fontSize: 9, lineHeight: 1 }}>•</Typography>
                                  <Typography variant="caption" sx={{ color: '#3c9bff', fontSize: 11, lineHeight: 1 }}>{w.light}</Typography>
                                </Box>
                              </Box>
                            );
                          })()}
                    ...
                    >
                      ...
                      {(() => {
                        ...
                        return (
                          <Box sx={{ mb: 1, display: 'flex', alignItems: 'center', justifyContent: 'flex-start' }}>
                            <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, minHeight: 24, flex: '0 0 auto', mr: 1 }}>
                              {hasMundus && (
                                <>
                            ...
                            <Typography variant="body2" color="text.secondary" sx={{ whiteSpace: 'nowrap', flex: '0 0 auto', flexShrink: 0, ml: 'auto', pr: 1 }}>
