...
import { AnalyzerPanelState, AnalyzerPanelStateKind } from '../AnalyzerPanelState';
      ...
      <Box sx={{ p: 3 }}>
          ...
          <Box sx={{ display: 'flex', gap: 4, flexWrap: 'wrap' }}>
            <Box sx={{ minWidth: 300 }}>
              <Stack spacing={1}>
                ...
                <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                  Map divided into 50x50 unit grid cells, showing only voxels where players spent
                  ≥30 seconds
                </Typography>
              </Stack>
            </Box>
        ...
        <Paper variant="outlined" sx={{ p: 3, mb: 3, borderRadius: 2 }}>
          ...
          <Box sx={{ display: 'flex', gap: 2, flexWrap: 'wrap', justifyContent: 'space-between' }}>
            <Tooltip
              title="Total number of tank position updates from resource change events"
              arrow
            >
              ...
              <Paper variant="outlined" sx={{ p: 3, mb: 3, borderRadius: 2 }}>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
                  {tanksWithData.map((tank, index) => {
                    const tankPositions = locationData.filter(
                      (point) => point.playerId === tank.id,
                    );
