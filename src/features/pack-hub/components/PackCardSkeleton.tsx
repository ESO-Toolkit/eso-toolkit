...
export const PackCardSkeleton: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <Box sx={{ flexGrow: 1 }}>
        <CardContent
          sx={{ display: 'flex', flexDirection: 'column', pt: 3, px: 2.5, pb: '20px !important' }}
        >
          <Skeleton
            variant="rounded"
            width={78}
          ...
          <Skeleton
            variant="text"
            width="95%"
            sx={{ mb: 1, bgcolor: isDark ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.05)' }}
          />
          <Skeleton
            variant="text"
            width="65%"
          ...
          >
            <Box
              sx={{
                ...
                flexShrink: 0,
                background: isDark
                  ? 'linear-gradient(180deg, rgba(196,164,74,0.5) 0%, rgba(196,164,74,0.2) 100%)'
                  : 'linear-gradient(180deg, rgba(196,164,74,0.35) 0%, rgba(196,164,74,0.12) 100%)',
              }}
              aria-hidden="true"
            />
