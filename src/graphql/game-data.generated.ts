 ...
 * });
 */
export function useGetAbilitiesQuery(baseOptions?: Apollo.QueryHookOptions<Types.GetAbilitiesQuery, Types.GetAbilitiesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<Types.GetAbilitiesQuery, Types.GetAbilitiesQueryVariables>(GetAbilitiesDocument, options);
      }
export function useGetAbilitiesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetAbilitiesQuery, Types.GetAbilitiesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<Types.GetAbilitiesQuery, Types.GetAbilitiesQueryVariables>(GetAbilitiesDocument, options);
        }
export function useGetAbilitiesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAbilitiesQuery, Types.GetAbilitiesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetAbilitiesQuery, Types.GetAbilitiesQueryVariables>(GetAbilitiesDocument, options);
        }
...
export type GetAbilitiesQueryResult = Apollo.QueryResult<Types.GetAbilitiesQuery, Types.GetAbilitiesQueryVariables>;
 ...
 * });
 */
export function useGetAbilityQuery(baseOptions: Apollo.QueryHookOptions<Types.GetAbilityQuery, Types.GetAbilityQueryVariables> & ({ variables: Types.GetAbilityQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<Types.GetAbilityQuery, Types.GetAbilityQueryVariables>(GetAbilityDocument, options);
      }
export function useGetAbilityLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetAbilityQuery, Types.GetAbilityQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<Types.GetAbilityQuery, Types.GetAbilityQueryVariables>(GetAbilityDocument, options);
        }
export function useGetAbilitySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetAbilityQuery, Types.GetAbilityQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetAbilityQuery, Types.GetAbilityQueryVariables>(GetAbilityDocument, options);
        }
...
export type GetAbilityQueryResult = Apollo.QueryResult<Types.GetAbilityQuery, Types.GetAbilityQueryVariables>;
 ...
 * });
 */
export function useGetClassQuery(baseOptions: Apollo.QueryHookOptions<Types.GetClassQuery, Types.GetClassQueryVariables> & ({ variables: Types.GetClassQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<Types.GetClassQuery, Types.GetClassQueryVariables>(GetClassDocument, options);
      }
export function useGetClassLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<Types.GetClassQuery, Types.GetClassQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<Types.GetClassQuery, Types.GetClassQueryVariables>(GetClassDocument, options);
        }
export function useGetClassSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetClassQuery, Types.GetClassQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetClassQuery, Types.GetClassQueryVariables>(GetClassDocument, options);
        }
...
export function useGetClassesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<Types.GetClassesQuery, Types.GetClassesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<Types.GetClassesQuery, Types.GetClassesQueryVariables>(GetClassesDocument, options);
        }
