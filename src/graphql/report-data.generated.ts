 ...
 * });
 */
export function useGetReportEventsQuery(
  baseOptions: Apollo.QueryHookOptions<
    Types.GetReportEventsQuery,
    Types.GetReportEventsQueryVariables
  > &
    ({ variables: Types.GetReportEventsQueryVariables; skip?: boolean } | { skip: boolean })
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<Types.GetReportEventsQuery, Types.GetReportEventsQueryVariables>(
    GetReportEventsDocument,
    options
  );
}
export function useGetReportEventsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    Types.GetReportEventsQuery,
    Types.GetReportEventsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<Types.GetReportEventsQuery, Types.GetReportEventsQueryVariables>(
    GetReportEventsDocument,
    options
  );
}
export function useGetReportEventsSuspenseQuery(
  baseOptions?:
    | Apollo.SkipToken
    | Apollo.SuspenseQueryHookOptions<
        Types.GetReportEventsQuery,
  ...
  const options =
    baseOptions === Apollo.skipToken ? baseOptions : { ...defaultOptions, ...baseOptions };
  return Apollo.useSuspenseQuery<Types.GetReportEventsQuery, Types.GetReportEventsQueryVariables>(
    GetReportEventsDocument,
    options
  );
}
...
export type GetReportEventsSuspenseQueryHookResult = ReturnType<
  typeof useGetReportEventsSuspenseQuery
>;
export type GetReportEventsQueryResult = Apollo.QueryResult<
  Types.GetReportEventsQuery,
  Types.GetReportEventsQueryVariables
>;
