...
tech_stack,testing_framework_2,dependency,Playwright,playwright.config.ts,,tests,"End-to-end testing"
...
config_file,playwright.config.ts,typescript,Playwright E2E test configurations,playwright.config.ts,,,"End-to-end test configuration"
...
tool,playwright,test_framework,End-to-End Testing,playwright.config.ts,,,"Main, Nightly, Smoke configs with sharding support"
...
command,test_e2e,testing,Playwright tests (Chromium),,npm run test:e2e,,"End-to-end tests in Chromium"
command,test_e2e_headed,testing,E2E with browser UI,,npm run test:e2e:headed,,"E2E tests with visible browser"
command,test_e2e_ui,testing,Playwright UI mode,,npm run test:e2e:ui,,"Playwright interactive UI mode"
...
testing_strategy,e2e_tests,strategy,Playwright for full user workflows,playwright.config.ts,,,"End-to-end user workflow testing"
